...
from ..mapping.path_utils import PathMapper, PathMapping as PathMap
...
class MDXParser:
    ...
    def parse_mdx_file(self, mdx_path: str, method_name: str) -> MethodInfo:
        # Path resolution - pathlib handles relative paths correctly
...
class OpenAPIConverter:
    ...
    def __init__(self, base_path: str = ".", use_nested_structure: bool = True):
        self.base_path = Path(base_path)
    ...
    def write_openapi_file(self, spec: Dict[str, Any], method_name: str, version: str, 
        ...
        if self.use_nested_structure and self.path_mapper and mdx_path:
...
class MDXToOpenAPIConverter:
    ...
    def __init__(self, base_path: str = ".", use_nested_structure: bool = True):
        ...
        self.converter = OpenAPIConverter(base_path, use_nested_structure)
        self.use_nested_structure = use_nested_structure
        
        # Initialize mapper for method mapping functionality
        from ..mapping import MethodMapper
        self.mapper = MethodMapper(base_path, verbose=True)
        ...
        for ver in versions_to_process:
            ...
            for method_name, mapping in methods.items():
                ...
                try:
                    ...
                    # Pass MDX path for nested structure generation
                    self.converter.write_openapi_file(
                        openapi_spec, method_name, ver, output_dir, dry_run, mapping.mdx_path
                    )
                except Exception as e:
