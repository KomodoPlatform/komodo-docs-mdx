...
from ..scanning.extractors import ExtractedExample, MDXExtractor
...
class APIExampleManager:
    ...
    def __init__(self, base_path: str = ".", verbose: bool = True):
        ...
        self.file_ops = get_file_ops()  # Use unified file operations instead of missing ExampleFileManager
