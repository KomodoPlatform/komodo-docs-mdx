...
Parses Postman collection files to extract method names, folder structures,
and request details for creating hotlinks from method_path JSON files.
"""
...
class PostmanCollectionParser:
    ...
    def _extract_request_info(self, request_item: Dict, folder_path: List[str], 
                            item_index: int) -> Optional[PostmanRequest]:
