"""
Method Analyzer for Komodo DeFi Framework

This module analyzes method implementations to extract parameter information,
including types, requirements, defaults, and descriptions.
"""
...
class Parameter:
    ...
    is_array: bool = False
    nested_params: Optional[List['Parameter']] = None
...
class MethodAnalyzer:
    ...
    def parse_rust_struct(self, struct_definition: str) -> List[Parameter]:
    ...
    def parse_rust_type(self, field_name: str, rust_type: str) -> Optional[Parameter]:
    ...
    def generate_example_request(self, method_name: str, parameters: List[Parameter]) -> Dict:
    ...
    def generate_example_value(self, param: Parameter) -> Any:
    ...
    def generate_default_parameters(self, method_name: str) -> List[Parameter]:
        ...
        if 'enable' in method_name:
            params.append(Parameter("coin", "string", True, description="The coin to enable"))
            if 'task' in method_name:
                params.append(Parameter("task_id", "integer", True, description="The task identifier"))
        elif 'cancel' in method_name and 'task' in method_name:
            params.append(Parameter("task_id", "integer", True, description="The task identifier to cancel"))
        elif 'status' in method_name and 'task' in method_name:
            params.append(Parameter("task_id", "integer", True, description="The task identifier to check"))
        elif 'withdraw' in method_name:
            params.extend([
                Parameter("coin", "string", True, description="The coin to withdraw"),
                Parameter("to", "string", True, description="The destination address"),
                Parameter("amount", "string", True, description="The amount to withdraw")
            ])
        elif 'balance' in method_name:
            params.append(Parameter("coin", "string", True, description="The coin to get balance for"))
        elif 'stream' in method_name:
            params.append(Parameter("stream_id", "string", False, description="Optional stream identifier"))
        
        return params
    
    def generate_default_response_parameters(self, method_name: str) -> List[Parameter]:
        ...
        if 'task' in method_name:
            if 'init' in method_name:
                params.append(Parameter("task_id", "integer", True, description="The initialized task identifier"))
            elif 'status' in method_name:
                params.extend([
                    Parameter("status", "string", True, description="Current task status"),
                    Parameter("task_id", "integer", True, description="The task identifier")
                ])
            elif 'cancel' in method_name:
                params.append(Parameter("result", "string", True, description="Cancellation result"))
        elif 'balance' in method_name:
            params.extend([
                Parameter("coin", "string", True, description="The coin symbol"),
                Parameter("balance", "string", True, description="The available balance"),
                Parameter("unconfirmed_balance", "string", True, description="The unconfirmed balance")
            ])
        elif 'withdraw' in method_name:
            params.extend([
                Parameter("tx_hex", "string", True, description="The transaction in hexadecimal format"),
                Parameter("tx_hash", "string", True, description="The transaction hash")
            ])
        else:
            # Generic success response
            params.append(Parameter("result", "string", True, description="Operation result"))
