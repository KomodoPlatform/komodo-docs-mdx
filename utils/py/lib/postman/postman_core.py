#!/usr/bin/env python3
"""
Postman Core Components

Core classes and functionality for Postman collection generation.
Provides request processing, folder organization, and collection generation.
"""
...
from ..utils.file_utils import normalize_file_path
from ..utils.string_utils import convert_method_to_dir_name, format_method_name_for_display
