...
from .coins_config_loader import CoinsConfigLoader, CoinConfig
...
@dataclass
class ErrorInfo:
    """Information about method error types."""
    name: str
    type: str
    description: str
...
@dataclass
class ExampleInfo:
    """Example request/response for a method."""
    title: str
...
class EnhancedMethodInfo:
    """Enhanced method information with comprehensive analysis."""
    method_name: str
    api_version: str
    ...
    tags: List[str]
    structure_mismatches: Optional[List[str]] = None
...
class EnhancedRepositoryAnalyzer:
    ...
    async def analyze_method_comprehensive(self, method_name: str, version: str, 
                                         branch: Optional[str] = None) -> EnhancedMethodInfo:
        ...
        try:
            ...
            return EnhancedMethodInfo(
                ...
                response=None,  # Could be enhanced with response analysis
                errors=errors,
                examples=examples,
                related_methods=related_methods,
                tags=tags,
                structure_mismatches=mismatches if mismatches else None
            )
