...
export const description = "Learn how to write UTXO-based CC modules for KMD-based chains with this comprehensive guide by jl777, enabling secure and powerful smart contracts.";
