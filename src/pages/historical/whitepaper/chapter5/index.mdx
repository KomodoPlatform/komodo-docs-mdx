...
the overall framework, the asset chain will smoothly integrate with the rest of the Komodo ecosystem. We provide more details on this topic in [Part V](/historical/whitepaper/chapter8/)’s section regarding
smart contracts.
