...
Our dPoW technology is a key feature, as explained in [Part I](./chapter1/). dPoW provides
...
exchange to release the project to the world in a decentralized manner. Our decentralized exchange is called, BarterDEX, and it is thoroughly explained in [Part III](./chapter6/) of this paper. Because BarterDEX is a decentralized exchange, and through our atomic-swap
technology (also explained in [Part III](./chapter6/)), no third-party manipulators can prevent the
entrepreneur from their crowdsourcing and innovative endeavors.

Through our privacy technology, Jumblr, dICO participants can purchase the product within their inherent right to barter in private. A detailed explanation of Jumblr and its method of providing privacy is provided in [Part IV](./chapter7/) of this paper.
