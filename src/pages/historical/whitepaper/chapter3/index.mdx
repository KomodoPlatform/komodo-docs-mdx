...
[https://www.blocktrail.com/BTC/tx/313031a1ed2dbe12a20706dff48d3dffb0e39d15e3e4ff936d01f091fb3b8556#tx\_messages](https://www.blocktrail.com/BTC/tx/313031a1ed2dbe12a20706dff48d3dffb0e39d15e3e4ff936d01f091fb3b8556#tx_messages))
...
wish to securely alleviate any wait time a user might experience during this ten-minute period. The Trust API (briefly explained in [Part III](./chapter6/) of this white paper), our forthcoming CHIPS technology, and our Crypto Conditions and MoM smart-contract
...
of transactions per minute, this makes the combined ecosystem capable of supporting millions of transactions per minute. This includes cross-blockchain interoperability, via our atomic-swap powered technology, as explained in [Part III](./chapter6/). This makes
...
the cost. In the following section, [Part II](./chapter5/), we begin our discussion of an entrepreneur’s
formation and distribution of a Komodo asset chain. In [Part III](./chapter6/), we discuss in detail
our method of distribution and trading, using our atomic-swap technology. [Part IV](./chapter7/)
discusses how with each of these components, users have the option of zero-knowledge privacy. In [Part V](./chapter8/), we mention our smart-contract technology (our current development focus).
