export const title = "Notary node: Generate Address and Private Key for 3p coins";
export const description =
  "This document describes how to generate address and private key (WIF) for 3rd party coins using passphrase.";
...
*   Clone the repo: [https://github.com/DeckerSU/komodo\_scripts](https://github.com/DeckerSU/komodo_scripts)
