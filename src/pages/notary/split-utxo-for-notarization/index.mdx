export const title = "Split UTXO for Notarization";
export const description =
  "This document describes how to split UTXO for notarization.";
...
To find out the correct size UTXO for each coin, check [https://github.com/KomodoPlatform/dPoW/blob/master/iguana/dpow/dpow\_rpc.c#L20](https://github.com/KomodoPlatform/dPoW/blob/master/iguana/dpow/dpow_rpc.c#L20)
