...
export const description = "The MuSig Antara Module implements a new type of multi-signature functionality.";
...
[<b>Link to Musig Module Tutorial</b>](/antara/tutorials/musig-module-tutorial.md)
