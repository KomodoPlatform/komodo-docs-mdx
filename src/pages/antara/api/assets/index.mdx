...
export const description = "The Assets Module provides basic distributed exchange (DEX) functionality for trading tokens created using the Tokens module.";
...
"@type": "WebSite",
"name": "Antara Assets",
"url": "/docs/antara/api/assets/",
"datePublished": "",
"author": "komodo",
"creator": "",
"keywords":["Antara Assets",""]
}
</script>
...
"position": 3,
"item": {
"@id": "/docs/antara/api/assets",
"name": "Antara Assets: Powering DEX Token Trading"
}
} 
]
}
