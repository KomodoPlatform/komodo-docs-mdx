export const title = "Tokens Module:Creating & Managing On-Chain Colored Coins";
...
Tokens can be generated on any chain where the [ac_cc](/antara/setup/antara-customizations#ac-cc) parameter is enabled.
