import heirCC from "@/images/antara/heirCC-with-labels.png";
export const title = "Heir: Secure Cryptocurrency Inheritance Solution";
export const description = "The Heir Antara Module allows cryptocurrency funds to be passed on as an inheritance.";
...
<OptimizedImage
  title="Heir Antara Module"
  src={heirCC}
  classNaming="w-full"
  alt="Heir Antara Module"
/>
...
<Note>
  ...
  [tokencreate](/antara/api/tokens/#tokencreate) method and pass the `tokenid` as
  the last parameter of [heirfund.](/antara/api/heir/#heirfund)
</Note>
