...
This function recursively calls the [get\_system](#get-system-1) function. Based on the logic of the different kinds of systems requested, this function updates the indicated systems in the correct order.
...
An overloaded version of the [get\_systems](#get-systems-1) function.
...
The `has_system` function verifies whether or not a system is already registered in the [system\_manager](#system-manager).
