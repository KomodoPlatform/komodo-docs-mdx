...
| subscribe_to_internal_events | bool           | whether to subscribe to default system_manager events |
...
| Name | Type                         | Description                     |
| ---- | ---------------------------- | ------------------------------- |
| evt  | ecs::event::add_base_system& | {/* need a description here */} |
...
| Name                      | Type        | Description                   |
| ------------------------- | ----------- | ----------------------------- |
| number of systems updated | std::size_t | the number of systems updated |
...
This function recursively calls the [get_system](#get_system) function. Based on the logic of the different kinds of systems requested, this function updates the indicated systems in the correct order.
...
| Name    | Type                                                | Description                                    |
| ------- | --------------------------------------------------- | ---------------------------------------------- |
| TSystem | std::tuple\<std::add_lvalue_reference_t\<TSystems\> | a tuple containing multiple TSystems templates |

#### Response

| Name     | Type                                                | Description                                         |
| -------- | --------------------------------------------------- | --------------------------------------------------- |
| TSystems | std::tuple\<std::add_lvalue_reference_t\<TSystems\> | a reference to the template chosen by the developer |
...
An overloaded version of the [get_systems](#get_systems) function.
...
| Name              | Type                                                                         | Description                                          |
| ----------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------- |
| tuple of TSystems | std::tuple\<std::add_lvalue_reference_t\<std::add_const_t\<TSystems\>\>...\> | a tuple containing multiple TSystems templates types |

#### Response

| Name              | Type                                                                         | Description                                                  |
| ----------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------ |
| tuple of TSystems | std::tuple\<std::add_lvalue_reference_t\<std::add_const_t\<TSystems\>\>...\> | a tuple containing multiple references to TSystems templates |
...
The `has_system` function verifies whether or not a system is already registered in the [system_manager](#system_manager).
...
The `has_systems` function verifies whether or not a list of systems is already registered in the [system_manager](#system_manager).

This function recursively calls the [has_system](#has_system) function.
...
This function recursively calls the [mark_system](#mark_system) function.
...
This function recursively calls the [enable_system](#enable_system) function.
...
This function recursively calls the [disable_system](#disable_system) function.
...
| Name              | Type        | Description                      |
| ----------------- | ----------- | -------------------------------- |
| number of systems | std::size_t | the number of systems registered |
...
| Name     | Type        | Description                    |
| -------- | ----------- | ------------------------------ |
| sys_type | system_type | represents the type of systems |

#### Response

| Name              | Type        | Description                               |
| ----------------- | ----------- | ----------------------------------------- |
| number of systems | std::size_t | the number of systems of a specified type |
...
This function recursively calls the [create_systems](#create_systems) function.
...
Please see the [key_pressed | 1](#key-pressed-1) function for more information.
...
Please see the [key_released | 1](#key-released-1) function for more information.
...
| Name         | Type | Description                                           |
| ------------ | ---- | ----------------------------------------------------- |
| return_value | int  | the return value of the program when leaving the game |
...
Please see the [quit_game | 1](#quit-game-1) function for more information.
...
| Name     | Type          | Description         |
| -------- | ------------- | ------------------- |
| registry | ent::registry | the entity_registry |
