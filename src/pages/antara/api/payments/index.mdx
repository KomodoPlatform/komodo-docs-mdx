...
The paymentsairdrop RPC requires the [-ac_snapshot](../antara-setup/antara-customizations.html#ac-snapshot) to be active.
...
The `payments_airdroptokens` method is still in development. Please inquire on [Discord](komodoplatform.com/discord) for more details.
