...
export const description = "This customcc loadable library example is simply something that requires to send 1 coin.";
...
`MYCCLIBNAME` This is the name of the loadable library module being created. Here it is "customcc". This is what is used on the command line to load your custom consensus when [starting your custom blockchain](/installations/creating-asset-chains.html) on a komodo server.
