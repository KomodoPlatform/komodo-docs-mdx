export const title = "Introduction to Antara";
...
[<b>Link to "Smart Chains & Antara" Introduction</b>](/start-here/about-komodo-platform/product-introductions/#smart-chains-antara)
...
Please consult our [Learning Path Outlines](/start-here/learning-launchpad/learning-path-outline) section for more details on approaches to learning Antara from both a conceptual and technical perspective.
...
For a walkthrough covering multiple tutorials in a targeted fashion, please see the [Learning Launchpad](/start-here/learning-launchpad/learning-path-outline) section.
