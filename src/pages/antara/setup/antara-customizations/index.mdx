...
The user first executes the [paymentsairdrop](/antara/api/payments/#paymentsairdrop) method to create a Payments plan that is designed to distribute airdrops to addresses on the chain.
