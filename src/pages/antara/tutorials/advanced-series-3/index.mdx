...
export const description = "Explore the advanced tutorial on preparing for Heir Antara Module development, gain insight into Antara framework, and learn to use transactions as data sources.";
...
[Link to instructions to create a new default Smart Chain.](/smart-chains/tutorials/create-a-default-smart-chain#creating-a-new-smart-chain)
...
Wait a few moments, and then use the [<b>getinfo</b>](/smart-chains/api/control#getinfo) method to verify that your wallet now contains RICK funds.
