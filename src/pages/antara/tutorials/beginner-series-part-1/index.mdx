...
[<b>To return to the previous tutorial, click here.</b>](/antara/tutorials/overview-of-development-on-komodo-part-0.md)
...
<OptimizedImage
  title="Komodo Developer Path | Create a Blockchain"
  src={tutorial8}
  classNaming="w-full"
  alt="Komodo Developer Path | Create a Blockchain"
/>
