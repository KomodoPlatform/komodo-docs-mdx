...
export const description = "Understand CryptoConditions, and learn how Antara Modules serve as the data and logic layer.";

import veryfyWork from "@/images/antara/cc-verify-work-v2.3.png";
import antaraArch from "@/images/antara/CC-Antara-arch-v2.3.png";
import srtuctureGuide from "@/images/antara/cc-tx-structure-for-guide-v3.2.png";
...
<OptimizedImage
  ...
  src={veryfyWork}
  classNaming="w-full"
  alt=" Advanced Series — Final Conceptual Discussion"
/>
