...
export const description = "Explore the process of developing a prototype of the Heir Module.";
...
Recall that a Smart Chain must have the [<b>ac_cc</b>](/antara/setup/antara-customizations#ac-cc) and [<b>ac_ccenable</b>](/antara/setup/antara-customizations#ac-ccenable) customization parameters properly initiated for any Antara Module to function.
...
This content is abbreviated. [For links to the full source code and example files, click here.](/antara/tutorials/heir-module-tutorial#links-to-heir-source-code-and-building-instructions)
...
[For links to the full source code and example files, click here.](/antara/tutorials/heir-module-tutorial#links-to-heir-source-code-and-building-instructions)
