...
This tutorial assists the reader in discovering the process of creating a new Smart Chain with an active stablecoin using the [Pegs Antara Module.](./pegs)
...
Upon completion of this tutorial, the reader may follow the [user tutorial](./pegs-module-user-tutorial) and use the Smart Chain created here to discover the possibilities of the Pegs Module.
...
This tutorial requires that the tutorial reader compile the Komodo daemon from source code. For more instructions, please see the [installation section](#installation) .If you have access to two VPS, follow [this guide](/smart-chains/tutorials/create-a-default-smart-chain). If you want to launch this Smart Chain in your Personal Computer or using a single VPS, follow [this guide](/smart-chains/tutorials/creating-a-smart-chain-on-a-single-node)
