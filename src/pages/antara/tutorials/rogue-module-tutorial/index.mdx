...
export const description = "The Rogue Antara module serves as a proof-of-concept to demonstrate Antara's capabilities as a blockchain-based gaming technology.";
...
- [Single-Player Mode Walkthrough](/antara/customconsensus/rogue/#single-player-mode-walkthrough)
- [Multi-Player Mode Walkthrough](/antara/customconsensus/rogue/#multi-player-mode-walkthrough)
...
Due to the nature of saving and reusing characters, the Komodo implementation of Rogue changes the manner in which the user saves characters. Instead of typing `s` on the keyboard, type `Q + y + Enter`, then execute the [bailout](/antara/api/rogue/#bailout) method to conclude the game.
