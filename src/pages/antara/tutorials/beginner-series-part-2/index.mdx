...
export const description = "Learn how to use a faucet in the Komodo ecosystem to send and receive funds.";
...
[<b>To return to the previous tutorial, click here.</b>](/antara/tutorials/overview-of-development-on-komodo-part-1)
...
There are many types of Antara Modules, and the [Faucet Antara Module](/antara/api/faucet.html/#introduction) is but one of them.
...
- On the mining node we send some of our funds to the chain's built-in faucet
  - To accomplish this, in this guided tutorial we use an automated version of the [<b>faucetfund</b>](/antara/api/faucet.html/#faucetfund) Remote Procedure Call (RPC)
...
To consolidate them in the guided tutorial, we use an automated version of the [<b>sendtoaddress</b>](/smart-chains/api/wallet.html#sendtoaddress) RPC.
...
The `GETFUNDS` function in this guided tutorial is yet another automated version of an RPC. This time, the RPC is the [<b>faucetget</b>](/antara/api/faucet.html/#faucetget) method.
