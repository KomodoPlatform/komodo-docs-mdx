export const title = "Gaming Tutorial: Part-1";
export const description = "This tutorial presents the process of creating a gaming system using the Antara Gaming SDK.";
...
Please read the [Getting Started](gaming-sdk-tutorial-0) tutorial before beginning this tutorial.

Please also review the [ecs documentation](gaming) section of the API documentation, to gain a brief introduction to the essential concepts of this tutorial.
...
In the following video, the actions are performed on an OSX setup. Please refer to the [Getting Started Tutorial](gaming) for more information about other operating systems.
...
In order to load the system, use the function [create_system](/antara/api/gaming/#create-system) of the `system_manager` class.
