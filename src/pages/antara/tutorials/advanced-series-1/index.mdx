...
In the [Learning Launchpad Outline](/start-here/learning-launchpad/learning-path-outline) the reader received encouragement to understand the basics of blockchain technology in preparation for this tutorial. The [<b>Core Technology Discussions section</b>](/start-here/core-technology-discussions/introduction) provides a useful introduction to most concepts that are necessary for blockchain engineers.
