...
Use the [gatewayswithdraw](/antara/api/gateways/#gatewayswithdraw) method to claim the tokenized `KMD` on the `USDKTEST` Smart Chain.

Method structure:

`gatewayswithdraw bindtxid coin deposittxid destpub amount`
...
```bash
./komodo-cli -ac_name=USDKTEST gatewayswithdraw 50384e7668bd6908d8e0b67f1450c56f017186d802b1065c3258302a30b5adb2 KMD 9e08b1c5ac37cbce997ceaa68d4ca2d1368b815e8de275bb54d5e230a1341b5f 0217a6aa6c0fe017f9e469c3c00de5b3aa164ca410e632d1c04169fd7040e20e06 0.01
```
