...
If you are using a chain other than MUSIG, and if this chain's launch commands include the [<b>-ac_pubkey</b>](/antara/setup/antara-customizations/#ac-pubkey) parameter, do not change this <b>ac_pubkey</b> setting.
