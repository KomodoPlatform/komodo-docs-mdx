...
export const description = "Create fungible and non-fungible tokens on a test Smart Chain with customizable properties and metadata.";

import tutorial1 from "@/images/antara/2019-06-24-tutorial-4-img-1.png";
import tutorial2 from "@/images/antara/2019-06-24-tutorial-4-img-2.png";
import tutorial3 from "@/images/antara/2019-06-24-tutorial-4-img-3.png";
import tutorial4 from "@/images/antara/2019-06-24-tutorial-4-img-4.png";
import tutorial6 from "@/images/antara/2019-06-24-tutorial-4-img-6.png";
import tutorial7 from "@/images/antara/2019-06-24-tutorial-4-img-7.png";
...
<OptimizedImage
  title=" Komodo Developer Path | Understanding Tokens"
  src={tutorial1}
  classNaming="w-full"
  alt=" Komodo Developer Path | Understanding Tokens"
/>
...
If you are ready to proceed with the next tutorials in our educational series, return to the [<b>Learning Launchpad</b>](/start-here/learning-launchpad/learning-path-outline/#introduction) section.

- Create a new Smart Chain
  - [<b>Create a Default Smart Chain</b>](/smart-chains/tutorials/create-a-default-smart-chain/#creating-a-new-smart-chain)
  - [<b>ac_name</b>](/antara/setup/antara-customizations/#ac-name)
- Create a coin supply
  - [<b>ac_supply</b>](/antara/setup/antara-customizations/#ac-supply)
