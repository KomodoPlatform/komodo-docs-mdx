...
export const description = "Use the generate RPC call to mine blocks in the regtest mode and manage the mining status with the getgenerate and setgenerate methods in the Komodo software.";
...
The `setstakingsplit` method allows the user to decide what happens to a UTXO that is successfully able to stake a block in the POS64 staking system (i.e. a Smart Chain started using the [-ac_staked](/antara/setup/antara-customizations.md#ac-staked) parameter).
