export const title = "Smart Chain Rawtransactions Methods";
export const description = "Interact with komodod using RPC calls such as createrawtransaction, decoderawtransaction, decodescript and sendrawtransaction.";
