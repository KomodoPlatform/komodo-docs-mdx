...
export const description = "The following methods interact with Antara Modules that make use of the `-ac_cclib` parameter.";
...
The library is loaded at runtime using the [-ac_cclib](/antara/setup/antara-customizations#ac-cclib) parameter.
