export const title = "nSPV API Reference for Smart Chains | Gleec";
export const description =
  "Explore the nSPV API reference, covering enhanced Simple Payment Verification methods for Komodo Smart Chains";
...
Use this method to broadcast the hex value returned by the [nspv\_spend](/smart-chains/api/nspv/#nspv-spend) method.
...
| valueBalance  | (number)         |                                                                                                                                                 |
| result        | (string)         | whether the command succeeded                                                                                                                   |
| hex           | (string)         | the transaction in hex format; it should be broadcast to the network using the [nspv\_broadcast](/smart-chains/api/nspv/#nspv-broadcast) method |
...
This method is an internal function to be used by the [nspv\_listtransactions](/smart-chains/api/nspv/#nspv-listtransactions) method
