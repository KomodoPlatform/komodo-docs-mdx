...
export const description = "Jumblr functionality is currently disabled on the main KMD chain. Please consult Smart Chain developers for more information.";
...
<Note>
  While shielded z_address technology is available on all KMD-based Smart
