...
export const description = "Interact with komodod using RPC calls such as addmultisigaddress, backupwallet, dumpprivkey and getaccount.";
...
For more information, please see these instructions: [Encrypt Komodo's wallet.dat File](https://docs.komodoplatform.com/komodo/encrypt-wallet)
...
| Name           | Type                                         | Description                                                                |
| -------------- | -------------------------------------------- | -------------------------------------------------------------------------- |
| "z_privatekey" | (string, required)                           | the z_privatekey (see [z_exportkey](/smart-chains/api/wallet#z-exportkey)) |
...
| minconf          | (numeric, optional, default=1)       | the minimum confirmations to filter                                                                                 |
| maxconf          | (numeric, optional, default=9999999) | the maximum confirmations to filter                                                                                 |
| includeWatchonly | (bool, optional, default=false)      | whether to also include watchonly addresses (see [z_importviewingkey](/smart-chains/api/wallet#z-importviewingkey)) |
...
<Note type="warning">
  CAUTION: <b>z_mergetoaddress</b> is DISABLED but can be enabled as an
...
| transparent_limit | (numeric, optional, default=50)     | limit on the maximum number of transparent utxos to merge; you may set this value to 0 to use the node option [mempooltxinputlimit](/smart-chains/setup/common-runtime-parameters#mempooltxinputlimit) |
