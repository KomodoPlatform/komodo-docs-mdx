...
export const description = "Generate payment disclosures and validate them using the z_getpaymentdisclosure and z_validatepaymentdisclosure RPC calls in the Komodo software.";
