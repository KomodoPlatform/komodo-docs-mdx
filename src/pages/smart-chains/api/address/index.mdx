...
export const description = "Interact with komodod using RPC calls such as getaddressbalance, getaddressdeltas, getaddressmempool, getaddresstxids, and getaddressutxos.";
