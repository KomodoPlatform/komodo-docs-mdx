...
export const description = "Create a Komodo Smart Chain on a single node by running two daemons with different data directories. Learn how to launch and interact with the daemons.";
...
The default [p2p](/setup/common-runtime-parameters#port) and [rpc](/setup/common-runtime-parameters#rpcport) ports of our chain are `14165` and `14166` respectively.
...
Add a new line `port=<choose a port number betwen 1 and 65000>` to the file. This value indicates the [p2pport](/setup/common-runtime-parameters#port) used by the second daemon.
