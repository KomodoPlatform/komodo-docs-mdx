...
export const description = "Create a Komodo Smart Chain on a single node by running two daemons with different configurations. Learn how to launch and interact with the daemons.";
