export const title = "Get a new pubkey to launch a Smart Chain";
export const description =
  "This document describes a step-by-step process of getting a new pubkey to launch a Smart Chain.";
