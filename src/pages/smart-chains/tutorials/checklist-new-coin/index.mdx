export const title = "Checklist New Komodo Smart Chain";
export const description =
  "Complete Checklist for New Komodo Smart Chains to Setup Explorer, Electrum Servers, Activate dPoW & AtomicDEX Trading";
...
1.  The various parameters using which the new blockchain can be customized are explained here: [Parameters to customize Blockchains created using Komodo Platform](/antara/setup/antara-customizations/)
2.  Install explorer: [gcharang/komodo-install-explorer](https://github.com/gcharang/komodo-install-explorer)
3.  [Setup Electrum SPV server](/komodo/setup-electrumX-server/)
...
2.  SuperNET repo (`dev` branch) - [jl777/SuperNET](https://github.com/jl777/SuperNET)
...
2.  Explorer - [jl777/coins:explorers/ZEX@master](https://github.com/jl777/coins/blob/master/explorers/ZEX)
3.  Coin info - [jl777/coins:coins@master#L2789](https://github.com/jl777/coins/blob/master/coins#L2789)
4.  Electrum servers (BEER as example)- [jl777/coins:electrums/BEER@master](https://github.com/jl777/coins/blob/master/electrums/BEER)
