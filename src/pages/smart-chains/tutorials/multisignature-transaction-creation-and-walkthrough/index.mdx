...
export const description = "Learn how to create and use a multisignature (multisig) wallet for increased transaction security. Follow the step-by-step guide with two nodes and KMD main chain.";
