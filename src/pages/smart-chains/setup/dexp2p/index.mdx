...
<Note>
  ...
  *   there is a detailed explanation on how publishing and subscribing works [here](../tutorials/publish-download-files-dexp2p/)
...
A detailed explanation on how the command works and its usage can be found [in this linked tutorial](../tutorials/streaming-dexp2p/)
...
<Note>
  ...
  [here](../tutorials/publish-download-files-dexp2p/)
</Note>
