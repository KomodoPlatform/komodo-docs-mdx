export const title = "nSPV Setup Guide for Smart Chains | Gleec";
export const description = "Follow this guide to set up nSPV, an enhanced Simple Payment Verification technology, for your Komodo Smart Chain";
...
```bash
curl --url "http://127.0.0.1:$port" --data "{\"userpass\":\"RPC_UserP@SSW0RD\",\"method\":\"spentinfo\",\"vout\":1,\"txid\":\"e07709088fa2690fdc71b43b5d7760689e42ca90f7dfb74b18bf47a1ad94c855\"}"
```
