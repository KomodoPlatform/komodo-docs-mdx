...
export const description = "Enhance SPV with nSPV technology on Komodo chains. Interact via command line or curl commands to execute RPCs and broadcast transactions securely.";
...
```bash
curl --url "http://127.0.0.1:$port" --data "{\"userpass\":\"MM2_RPC_PASSWORD\",\"method\":\"spentinfo\",\"vout\":1,\"txid\":\"e07709088fa2690fdc71b43b5d7760689e42ca90f7dfb74b18bf47a1ad94c855\"}"
```
