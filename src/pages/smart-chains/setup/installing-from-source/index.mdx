...
export const description = "Learn how to install Smart Chain software from source code on Linux. Build the Komodo daemon and komodo-cli applications for optimal performance.";
...
- [<b>MacOS</b>](/smart-chains/setup/installing-from-source#macos)
