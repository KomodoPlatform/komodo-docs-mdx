...
Launching a decentralized exchange, crypto wallet, or other DeFi products can be complex, expensive, and time-consuming. Thus why we created the [<b>Komodo SDK</b>](/start-here/core-technology-discussions/komodo-sdk/) - an easy solution for building innovative blockchain applications.
...
- An orderbook powered by peer-to-peer network
...
[Get started](/start-here/komodo-sdk)

{/*
In addition to this, Komodo's blockchain technology enables developers to create fully independent blockchains in a secure and highly composable environment.

Each independent blockchain built on using Komodo has a wide range of capabilities, including:
