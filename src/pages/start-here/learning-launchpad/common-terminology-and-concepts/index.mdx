...
For more information about centralized exchanges, [read the Introduction to AtomicDEX here.](/atomicdex/tutorials/#why-is-atomicdex-special)
...
For more information, [read the dPoW section on notary nodes.](/start-here/core-technology-discussions/delayed-proof-of-work#the-komodo-solution-delayed-proof-of-work-dpow)
...
Users use the [z_sendmany](/smart-chains/api/wallet#z-sendmany) remote procedure call (RPC) when dealing with z addresses.
