...
export const description = "Install Komodo Smart Chain and AtomicDEX software effortlessly with pre-compiled binaries or Docker images. Full installation instructions in the documentation.";


export const description = "Komodo Smart Chain Installation ";
...
[Link to AtomicDEX API](/atomicdex/atomicdex-api)
