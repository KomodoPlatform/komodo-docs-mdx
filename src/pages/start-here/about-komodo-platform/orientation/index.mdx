export const title = "About Komodo Platform: Getting Started | Gleec";
export const description = "Get oriented in the Komodo Smart Chain docs, built for developers. Covers prerequisite knowledge and compatibility details";
...
[<b>Link to Core Technology Discussion: Delayed Proof of Work</b>](/start-here/core-technology-discussions/delayed-proof-of-work/)
