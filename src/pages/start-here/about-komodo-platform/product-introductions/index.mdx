...
export const description = "Explore Smart Chains, Antara framework, and AtomicDEX for customizable blockchains and seamless asset trading. Discover advantages and Antara modules.";

export const description = "Komodo platform product introductions";
