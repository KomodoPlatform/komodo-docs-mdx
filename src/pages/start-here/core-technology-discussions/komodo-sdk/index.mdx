...
It provides a comprehensive set of tools that empower developers, businesses, and end-users alike. Each component within the SDK serves a distinct purpose and contributes to an integrated experience, streamlining the process of building, deploying, and managing blockchain and DeFi applications. In this doc, we will explore the key components that make up the “new” Komodo SDK and discuss their features, functions, and key purpose.
...
- Taker orders on DEX trades within Komodo Wallet (and any Komodo DeFi Framework Powered DEX) receive a 10% fee reduction on all KMD trading pairs
