...
*   The entrepreneur can fork the [AtomicDEX Desktop repository](https://github.com/KomodoPlatform/komodo-wallet-desktop) and add their coin/token to the GUI.
...
*   The entrepreneur can fork the [AtomicDEX Desktop repository](https://github.com/KomodoPlatform/komodo-wallet-desktop) or start from scratch. They create a custom IDO GUI with the specific features needed to conduct an IDO and only add the coins/tokens involved in their IDO.
