...
If Maker does not proceed with his next step (spending the payment), then after lock time expires Taker's Komodo DeFi Framework protocol will automaticallyrefund the payment.
