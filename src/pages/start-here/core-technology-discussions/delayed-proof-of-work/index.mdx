...
export const description = "Komodo’s form of providing security is called Delayed Proof of Work (dPoW). This security method builds on the most advanced form of blockchain security in existence";
...
<Note>
  Nakamoto used a feature called "coinbase," which is similar to OP_RETURN. A
