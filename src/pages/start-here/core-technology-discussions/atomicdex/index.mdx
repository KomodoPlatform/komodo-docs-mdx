export const title = "AtomicDEX and Atomic Swaps";
export const description = "Komodo’s decentralized exchange, AtomicDEX, allows people to trade cryptocurrency coins without a counterparty risk.";
...
<Note>
  The `dexfee` is actually calculated as "the greater of either `0.0001 TAKER
    COIN` or `1/777th` the size of the desired order"
</Note>
