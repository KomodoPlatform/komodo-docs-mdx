...
Z addresses often have RPCs that are separate from the RPCs used for T addresses. For example, [<b>z_gettotalbalance</b>](/smart-chains/api/wallet#z-gettotalbalance) is separate from [<b>getbalance.</b>](/smart-chains/api/wallet#getbalance)
...
All of the following transactions are accomplished using the [<b>z_sendmany</b>](/smart-chains/api/wallet#z-sendmany) RPC.
