export const title = "How to Find the Right IBC Channel for Transfers | Gleec";
export const description = "Learn how to find the right IBC channel for transferring assets between chains using Komodo Wallet";
...
4.  Set the `ibc_source_channel` value to `3` (the channel for IRIS in the above image alongside OSMOSIS).
5.  Send your funds.
