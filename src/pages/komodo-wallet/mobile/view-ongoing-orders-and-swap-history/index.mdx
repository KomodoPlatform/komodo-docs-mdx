...
<OptimizedImage title=" How to View Ongoing Orders and Swap History on Komodo Mobile Wallet" src={howToViewOngoingOrder1} classNaming="w-full" alt=" How to View Ongoing Orders and Swap History on Komodo Mobile Wallet" />
...
<OptimizedImage title=" How to View Ongoing Orders and Swap History on Komodo Mobile Wallet" src={howToViewOngoingOrder2} classNaming="w-full" alt=" How to View Ongoing Orders and Swap History on Komodo Mobile Wallet" />
