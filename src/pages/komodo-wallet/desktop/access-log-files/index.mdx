...
<OptimizedImage title="Accessing Komodo Wallet Log Files" src={accessLogFiles2} classNaming="w-full" alt="Accessing Komodo Wallet Log Files" />

For each session of Komodo Wallet, two log files are created

<OptimizedImage title="Accessing Komodo Wallet Log Files" src={accessLogFiles3} classNaming="w-200" alt="Accessing Komodo Wallet Log Files" />
