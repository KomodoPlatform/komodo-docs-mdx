...
After creating and logging in to your wallet, [Komodo Wallet Desktop](https://atomicdex.io/) will launch with [BTC](https://bitcoin.org/en/), [LTC](https://litecoin.org/) and [KMD](https://komodoplatform.com/) enabled by default. To activate additional coins, click on the "Add Crypto" button in the sidebar.
