...
import viewWalletAddress1 from "@/public/images/desktop/view-wallet-address-01.png";
import viewWalletAddress2 from "@/public/images/desktop/view-wallet-address-02.png";
import viewWalletAddress3 from "@/public/images/desktop/view-wallet-address-03.png";
...
For the test coins RICK & MORTY, there is also a "Faucet" button which will send you some free coins for you to use testing the [Komodo Wallet](https://atomicdex.io/) trading features. _Please note that RICK & MORTY coins have no value_.