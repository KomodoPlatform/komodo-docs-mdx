...
For the test coins RICK & MORTY, there is also a "Faucet" button which will send you some free coins for you to use testing the [Komodo Wallet](https://atomicdex.io/) trading features. *Please note that RICK & MORTY coins have no value*.
