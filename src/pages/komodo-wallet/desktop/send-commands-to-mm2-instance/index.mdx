...
import sendCommandsToMM2Instance4 from "@/public/images/desktop/send-commands-to-mm2-instance-04.png";
...
Note: Every time the Komodo Wallet Desktop application is restarted, the "RPC password/userpass" is also reset. So copy it and update the value of the "userpass" variable in the environment named "AtomicDEX" in Postman
