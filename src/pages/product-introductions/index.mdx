...
export const description = "Komodo's Smart Chain technology allows you to create secure and fully autonomous blockchains that are designed for a specific purpose.";


export const description = "Komodo platform overview";
...
[Read an in-depth discussion on the advantages of the Antara Framework here.](/antara/tutorials/overview-of-antara-modules-part-i.html)
...
[Learn more about Smart Chains here.](/start-here/core-technology-discussions/antara.html#antara-smart-chains-2)
