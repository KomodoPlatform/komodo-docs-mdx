...
export const description = "This guide describes a step-by-step process to test komodo source from jl777 branch to make sure all the assetchains sync from scratch properly.";
