export const title = "How to extract swap data from a AtomicDEX mobile log file";
export const description = "This guide describes a step-by-step process to extract swap data from a AtomicDEX mobile log file.";
