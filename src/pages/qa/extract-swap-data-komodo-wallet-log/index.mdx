export const title = "How to extract swap data from a Komodo mobile wallet log file";
export const description = "This guide describes a step-by-step process to extract swap data from a Komodo mobile wallet log file.";
...
<Note>
  *   the following code is from [https://github.com/smk762/pytomicDEX/blob/master/scripts/parse\_logs.py](https://github.com/smk762/pytomicDEX/blob/master/scripts/parse_logs.py)
