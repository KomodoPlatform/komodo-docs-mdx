export const title = "Build Instructions for AtomicDEX Desktop";
export const description = "This guide describes a step-by-step process to build the AtomicDEX desktop app.";
