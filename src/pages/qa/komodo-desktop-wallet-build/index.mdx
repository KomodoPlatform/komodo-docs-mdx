export const title = "Build Instructions for Komodo Desktop Wallet";
export const description = "This guide describes a step-by-step process to build the Komodo Desktop Wallet.";

# Build Instructions for Komodo Desktop Wallet
...
cd komodo-wallet-desktop/ci_tools_atomic_dex
nimble build
