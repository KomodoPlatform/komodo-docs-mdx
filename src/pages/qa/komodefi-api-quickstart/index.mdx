export const title = "Start using or testing AtomicDEX quickly";
export const description = "This guide describes a step-by-step process to quickly start using AtomicDEX.";

# Start using or testing AtomicDEX quickly

Download the latest release of AtomicDEX-API for your OS from [https://github.com/KomodoPlatform/komodo-defi-framework/releases](https://github.com/KomodoPlatform/komodo-defi-framework/releases)
