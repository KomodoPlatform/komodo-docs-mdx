export const title = "Use adb to collect GUI logs of the AtomicDEX android app";
export const description = "This document describes how to use adb to collect logs for the atomicDEX android app.";

import powerShell from "@/public/images/qa/power-shell.png";
import usbDebugging from "@/public/images/qa/allow-usb-debugging.png";
