...
*   Follow the instructions in [this linked guide](/qa/extract-swap-data-atomicdex-log/) to extract the swap data from the log file into a format usable by `mm2`
...
*   Follow the instructions in [this linked guide](/qa/atomicdex-quickstart/) to download, configure and setup AtomicDEX on your desktop. When creating the file `MM2.json` as described in the guide, use the seed words from AtomicDEX mobile as the value for the key `"passphrase"`
