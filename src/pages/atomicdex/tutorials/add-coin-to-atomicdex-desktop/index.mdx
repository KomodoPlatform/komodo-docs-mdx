...
<CollapsibleSection expandedText='Hide Smartchain example' collapsedText='Show Smartchain example'>
```json
...
<CollapsibleSection expandedText='Hide ERC20 example' collapsedText='Show ERC20 example'>
```json
  "BAT-ERC20": {
    "coin": "BAT-ERC20",
...
<CollapsibleSection expandedText='Hide BEP20 example' collapsedText='Show BEP20 example'>
```json
  "BTC-BEP20": {
    "coin": "BTC-BEP20",
    "name": "Bitcoin",
...
<CollapsibleSection expandedText='Hide QRC20 example' collapsedText='Show QRC20 example'>
```json
  "DIMI-QRC20": {
    "coin": "DIMI-QRC20",
    "name": "DiminutiveCoin",
...
<CollapsibleSection expandedText='Hide PLG20 example' collapsedText='Show PLG20 example'>
```json
  "COMP-PLG20": {
    "coin": "COMP-PLG20",
    "name": "Compound",
...
If you have [created a new smart chain](/smart-chains/tutorials/create-a-default-smart-chain) and need a designer to help with creating an icon, there is much talent within the [Komodian community](https://discord.gg/53dxfFWj3x)
