...
We recommend that the user [have a Virtual Private Server (VPS)](https://developers.komodoplatform.com/smart-chains/tutorials/basic-environment-setup-for-linux-vps) with *at least* the following specifications.
