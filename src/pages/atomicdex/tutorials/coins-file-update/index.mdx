...
export const description = "This guide describes how to update a coins file in a older format to work with the latest AtomicDEX-API.";

# How to update the coins file to work with the latest atomicDEX-API

## Instructions

- Compile the latest `mm2` binary following [these instructions](/atomicdex/setup/)
