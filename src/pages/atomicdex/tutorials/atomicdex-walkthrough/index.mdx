...
export const description =
  "This guide describes a step-by-step process to get started with AtomicDEX-API.";
...
<Note>
  ...
  the AtomicDEX API can be found in the [configure mm2
  guide](/atomicdex/setup/configure-mm2-json).
</Note>
...
To see the orders listed on the AtomicDEX orderbook, use the [`orderbook`](/atomicdex/api/legacy/orderbook/) method:
