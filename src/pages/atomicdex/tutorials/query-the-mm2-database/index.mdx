export const title = "How to Query the MM2 SQLite Database";
...
This table stores a record of all nodes [added for stats collection](/atomicdex/api/v20/add_node_to_version_stat) in this pubkey's MM2.db
...
This table stores a record of results returned by registered nodes [tracked for node stats collection](/atomicdex/api/v20/start_version_stat_collection) in this pubkey's MM2.db
