...
After using the [update\_nft](atomicdex/api/v2-dev/non_fungible_tokens/update_nft) method to initialise your local NFT database,
...
The NFTs listed above are all spam, and will be ignored by the [list\_nfts](atomicdex/api/v2-dev/non_fungible_tokens/list_nfts) method.
