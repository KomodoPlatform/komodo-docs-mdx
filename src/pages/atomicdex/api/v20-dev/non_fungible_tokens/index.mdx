...
*   Update NFT [update\_nft](/atomicdex/api/v20-dev/non_fungible_tokens/#update-nft)
*   Refresh NFT metadata with [refresh\_nft\_metadata](/atomicdex/api/v20-dev/non_fungible_tokens/#refresh-nft-metadata)
