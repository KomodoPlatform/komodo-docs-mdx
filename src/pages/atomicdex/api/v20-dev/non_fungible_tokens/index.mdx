...
| uri_meta             | object           | A TokenMetadata object. The contents of this object varies, but may include values for `image`, `token_name`, `description`, `attributes` or `animation_url`. |
