...
| page_number   | integer          | Optional, defaults to `0`. The page offset for items in response.                                         |
...
<CodeGroup title="get_nft_list" tag="POST" label="get_nft_list" mm2MethodDecorate="true">
```json
{
...
<CodeGroup title="get_nft_transfers" tag="POST" label="get_nft_transfers" mm2MethodDecorate="true">
```json
{
    "userpass": "MM2_RPC_PASSWORD",
...
<CodeGroup title="get_nft_metadata" tag="POST" label="get_nft_metadata" mm2MethodDecorate="true">
```json
{
  "userpass": "MM2_RPC_PASSWORD",
...
<CodeGroup title="update_nft" tag="POST" label="update_nft" mm2MethodDecorate="true">
```json
{
  "userpass": "'$USERPASS'",
  "method": "update_nft",
...
<CodeGroup title="refresh_nft_metadata" tag="POST" label="refresh_nft_metadata" mm2MethodDecorate="true">
```json
{
  "userpass": "'$USERPASS'",
...
| tx_hex               | string           | Raw hex of signed transaction. Use this with the [send_raw_transaction](/atomicdex/api/legacy/send_raw_transaction) RPC to broadcast the transaction. |
...
<CodeGroup title="withdraw_nft" tag="POST" label="withdraw_nft" mm2MethodDecorate="true">
```json
{
  "userpass": "MM2_RPC_PASSWORD",
  "method": "withdraw_nft",
