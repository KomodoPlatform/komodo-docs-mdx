...
export const description = "Prepare your Trezor device for use in the AtomicDEX API, and authenticate using your PIN or phrase.";

import trezorpin from "@/images/api-images/trezor_pin.png";

# Trezor Initialisation

The methods below prepare your Trezor device for use within the AtomicDEX API. Once completed, you can authenticate using your PIN or phrase with [task::init\_trezor::user\_action](/atomicdex/api/v20-dev/task_init_trezor/#user-action).

## init {{title : '', label : 'task::init_trezor::init', tag : 'API-v2'}}
...
## status {{title : '', label : 'task::init_trezor::status', tag : 'API-v2'}}
...
## cancel {{title : '', label : 'task::init_trezor::cancel', tag : 'API-v2'}}
...
## user\_action {{title : '', label : 'task::init_trezor::user_action', tag : 'API-v2'}}
