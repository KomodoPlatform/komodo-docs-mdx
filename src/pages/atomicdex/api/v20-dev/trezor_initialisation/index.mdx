...
<CollapsibleSection expandedText="Hide Response" collapsedText="Show Response">
  ...
  *   `UserActionRequired` - This will either be `EnterTrezorPin` or `EnterTrezorPassphrase`. Refer to the [task::init\_trezor::user\_action](#task_trezor_user_action) section for more information.
  ...
  *   `NoSuchTask` - Something went wrong or `task::init_trezor::init` was not called. Refer to the [task::init\_trezor::init](#task_init_trezor_init) section for more information.
