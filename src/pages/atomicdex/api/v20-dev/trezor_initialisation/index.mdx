...
The methods below prepare your Trezor device for use within the AtomicDEX API. Once completed, you can authenticate using your PIN or phrase with [task::init\_trezor::user\_action](#task-init-trezor-user-action).
...
<CodeGroup title="" tag="POST" label="task::init_trezor::init">
...
<CodeGroup title="" tag="POST" label="task::init_trezor::status">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::init_trezor::cancel">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::init_trezor::user_action">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
