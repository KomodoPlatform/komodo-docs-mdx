export const title = "AtomicDEX: Coin Activation Tasks";
...
UTXO coins are activated using this method. For QTUM coins, refer to [task::enable\_qtum::init](#task-enable-qtum-init)
...
| .scan\_policy                  | string  | Whether or not to scan for new addresses. Select from `do_not_scan`, `scan_if_new_wallet` or `scan`. Note that `scan` will result in multple requests to the AtomicDEX-API.                                      |
...
<CodeGroup title="" tag="POST" label="task::enable_utxo::init">
...
<CodeGroup title="" tag="POST" label="task::enable_utxo::status">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::enable_utxo::user_action">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::enable_qtum::init">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::enable_qtum::status">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::enable_qtum::user_action">
  ```json {{ mm2MethodDecorate : true }}
  {
      "userpass": "MM2_RPC_PASSWORD",
      "mmrpc": "2.0",
