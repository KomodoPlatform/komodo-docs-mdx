...
#### Command to sync from block 2528700, with custom .zcash-params path and scan params
...
#### Command to sync sapling activation height (earliest)
...
<CodeGroup title="" tag="POST" label="task::enable_z_coin::cancel">
  ```json {{ mm2MethodDecorate : true }}
  {
    "userpass": "MM2_RPC_PASSWORD",
...
<CodeGroup title="" tag="POST" label="z_coin_tx_history">
  ```json {{ mm2MethodDecorate : true }}
  {
    "userpass": "MM2_RPC_PASSWORD",
