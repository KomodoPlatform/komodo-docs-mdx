export const title = "ZHTLC Coin Methods";
export const description = "Activate ZHTLC coins ARRR, ZOMBIE with a two-step process. Initial activation may take longer, subsequent ones will be faster.";
