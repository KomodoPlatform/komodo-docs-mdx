...
## Initialize Z Coin Activation {{title : 'Initialize Z Coin Activation', label : 'task::enable_z_coin::init', tag : 'API-v2'}}
...
| activation\_params | object | A standard [ActivationRpcData](/atomicdex/api/v20/#activation-rpc-data) object. |
...
## Activation Status {{title : 'Activation Status', label : 'task::enable_z_coin::status', tag : 'API-v2'}}
...
## Cancel Initialization {{title : 'Cancel Initialization', label : 'task::enable_z_coin::cancel', tag : 'API-v2'}}
...
## Z Coin Transaction History {{title : 'Z Coin Transaction History', label : 'z_coin_tx_history', tag : 'API-v2'}}
