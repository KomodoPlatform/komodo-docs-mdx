export const title = "HD Wallets Overview";
export const description = "Activate and manage multiple coins in Hardware (HW) mode with the AtomicDEX API. Utilize Trezor hardware wallets for enhanced security.";
