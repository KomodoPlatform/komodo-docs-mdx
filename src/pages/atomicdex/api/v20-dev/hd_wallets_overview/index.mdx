...
*   Initialise the balance request with [task::account\_balance::init](/atomicdex/api/v20-dev/hd_account_balance_tasks/#task-account-balance-init)
*   Check the status of the balance request with [task::account\_balance::status](/atomicdex/api/v20-dev/hd_account_balance_tasks/#task-account-balance-status)
*   Request account addresses and balances, paginated and filtered (`External` or `Internal`) with [task::account\_balance::init](/atomicdex/api/v20-dev/hd_account_balance_tasks/#account-balance)
