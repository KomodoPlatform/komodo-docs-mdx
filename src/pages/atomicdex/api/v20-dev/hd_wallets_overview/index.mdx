...
<DevComment>  Is this still a thing?
*   Authenticate the activation with [task::enable\_utxo::user\_action](/atomicdex/api/v20-dev/coin_activation_tasks/#task-enable-utxo-user-action)
</DevComment>
...
<DevComment>  Is this still a thing?
*   Authenticate the activation with [task::enable\_qtum::user\_action](/atomicdex/api/v20-dev/coin_activation_tasks/#task-enable-qtum-user-action)
</DevComment>
