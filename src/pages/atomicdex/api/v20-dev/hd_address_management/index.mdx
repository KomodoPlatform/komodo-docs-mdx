export const title = "HD Address Management";
export const description = "HD wallets generate multiple addresses from a master key pair, improving privacy and security by directing transaction change to new, unused addresses.";
