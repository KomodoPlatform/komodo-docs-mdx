...
UTXO coins are activated using this method. For QTUM coins, refer to [task::enable_qtum::init](/atomicdex/api/v20-dev/task_enable_qtum/#init)
...
## user_action {{label : 'task::enable_utxo::user_action', tag : 'API-v2'}}
