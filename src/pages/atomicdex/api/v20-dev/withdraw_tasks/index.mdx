...
<CodeGroup title="" tag="POST" label="task::withdraw::init">
...
<CodeGroup title="" tag="POST" label="task::withdraw::status">
  ```json {{ mm2MethodDecorate : true }}
  {
    "mmrpc": "2.0",
    "userpass": "MM2_RPC_PASSWORD",
...
<CodeGroup title="" tag="POST" label="task::withdraw::cancel">
  ```json {{ mm2MethodDecorate : true }}
  {
    "userpass": "MM2_RPC_PASSWORD",
