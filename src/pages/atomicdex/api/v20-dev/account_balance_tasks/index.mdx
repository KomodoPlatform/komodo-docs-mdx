...
If you have activated a coin with the [task::enable_utxo::init](/atomicdex/api/v20-dev/coin_activation_tasks/#task-enable-utxo-init) or [task::enable_qtum::init](/atomicdex/api/v20-dev/coin_activation_tasks/#task-enable-qtum-init) and used the `"priv_key_policy": "Trezor"` parameter, your funds may be spread across a range of addresses under a specified account index. The methods below will return the combined balance of your account, detailing the balance for each active account address.

## task_account_balance_init
...
<CodeGroup title="" tag="POST" label="task::account_balance::init">
...
<CodeGroup title="" tag="POST" label="task::account_balance::status">
```json {{ mm2MethodDecorate : true }}
{
    "userpass": "MM2_RPC_PASSWORD",
    "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="task::account_balance::cancel">
```json {{ mm2MethodDecorate : true }}
{
    "userpass": "MM2_RPC_PASSWORD",
    "mmrpc": "2.0",
