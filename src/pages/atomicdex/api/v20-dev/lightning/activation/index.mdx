...
<CollapsibleSection expandedText="Hide Error Responses" collapsedText="Show Error Responses">
  ...
  <DevComment>
    https://github.com/KomodoPlatform/komodo-docs-mdx/pull/31#discussion\_r1197550229
...
<CollapsibleSection expandedText="Hide Response" collapsedText="Show Response">
  ...
  <Note>
    ...
    For exact channels balances and which channels are usable, use [lightning::channels::list\_open\_channels\_by\_filter](/atomicdex/api/v20-dev/lightning/channels#list_open_channels_by_filter).
  </Note>
