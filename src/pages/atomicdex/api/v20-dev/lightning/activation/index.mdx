...
## Initialize Lightning {{title : 'Initialize Lightning', label : 'task::enable_lightning::init', tag : 'API-v2'}}
...
## Initialization Status {{title : 'Initialization Status', label : 'task::enable_lightning::status', tag : 'API-v2'}}
...
## Cancel Initialization {{title : 'Cancel Initialization', label : 'task::enable_lightning::cancel', tag : 'API-v2'}}
