...
Coin's configuration is missing a required parameter.  Refer to the [coins file configuration for lightning](ADD LINK HERE WHEN AVAILABLE) for more information.
