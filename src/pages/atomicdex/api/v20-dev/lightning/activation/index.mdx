...
Coin is not in `coins` file. Refer to the [coins file configuration for lightning](/atomicdex/api/v20/lightning#lightning-coin-config-parameters) for more information.
