...
## lightning::channels::open_channel  {{label : 'Open a Channel', tag : 'API-v2'}}
...
| channel\_configs | object  | Optional. A standard [LightningChannelConfig](/atomicdex/api/v20/#lightning-channel-config) object.                                                                                                                                                                                                                                                                                   |

#### 📌 Example using an exact amount

<CodeGroup title="" tag="POST" label="lightning::channels::open_channel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::close_channel {{label : 'Close a Channel', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::channels::close_channel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::update_channel {{label : 'Update a Channel', tag : 'API-v2'}}
...
| uuid             | string | Unique channel identifier.                                                                  |
| channel\_options | object | A standard [LightningChannelOptions](/atomicdex/api/v20/#lightning-channel-options) object. |

#### 📌 Example to update all available channel options

<CodeGroup title="" tag="POST" label="lightning::channels::update_channel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::get_channel_details {{label : 'Get Channel Details', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::channels::get_channel_details" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::get_claimable_balances {{label : 'Get Claimable Balances', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::channels::get_claimable_balances" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::list_open_channels_by_filter  {{label : 'List Open Channels by Filter', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::channels::list_open_channels_by_filter" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## lightning::channels::list_closed_channels_by_filter  {{label : 'List Closed Channels by Filter', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::channels::list_closed_channels_by_filter" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
