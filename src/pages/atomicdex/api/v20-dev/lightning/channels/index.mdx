...
## Open Channel {{title : '', label : 'lightning::channels::open_channel', tag : 'API-v2'}}
...
## Close Channel {{title : '', label : 'lightning::channels::close_channel', tag : 'API-v2'}}
...
## Update Channel {{title : '', label : 'lightning::channels::update_channel', tag : 'API-v2'}}
...
## Get Channel Details {{title : '', label : 'lightning::channels::get_channel_details', tag : 'API-v2'}}
...
## Get Claimable Balances {{title : '', label : 'lightning::channels::get_claimable_balances', tag : 'API-v2'}}
...
## List Open Channels by Filter  {{title : '', label : 'lightning::channels::list_open_channels_by_filter', tag : 'API-v2'}}
...
## List Closed Channels by Filter  {{title : '', label : 'lightning::channels::list_closed_channels_by_filter', tag : 'API-v2'}}
