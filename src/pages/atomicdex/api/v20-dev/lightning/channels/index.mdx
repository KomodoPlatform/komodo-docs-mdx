...
| Parameter         | Type    | Description                                                                              |
|-------------------|---------|------------------------------------------------------------------------------------------|
| coin              | string  | The ticker of the coin you would like to view details abaout a channel.                  |
| uuid              | string  | Unique channel identifier.                                                               |
...
<DevComment>
`force_close_spend_delay` is not currently available in get_channel_details response, but should be aded soon.
