...
## Connect to a Node {{label : 'lightning::nodes::connect_to_node', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::nodes::connect_to_node" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="lightning::nodes::list_trusted_nodes" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## Add a Trusted Node {{label : 'lightning::nodes::add_trusted_node', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::nodes::add_trusted_node" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
## Remove a Trusted Node {{label : 'lightning::nodes::remove_trusted_node', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::nodes::remove_trusted_node" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
