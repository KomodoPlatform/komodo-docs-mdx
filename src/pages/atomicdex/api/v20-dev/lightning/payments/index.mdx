...
## Generate an invoice {{label : 'lightning::payments::generate_invoice', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::payments::generate_invoice" mm2MethodDecorate="true">
  ```json
  {
...
## Send a Payment {{label : 'lightning::payments::send_payment', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="lightning::payments::send_payment" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "mmrpc": "2.0",
...
<CodeGroup title="" tag="POST" label="lightning::payments::get_payment_details" mm2MethodDecorate="true">
  ```json
  {
...
<CodeGroup title="" tag="POST" label="lightning::payments::list_payments_by_filter" mm2MethodDecorate="true">
  ```json
  {
