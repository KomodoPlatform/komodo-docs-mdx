...
## Generate invoice {{title : 'Generate invoice', label : 'lightning::payments::generate_invoice', tag : 'API-v2'}}
...
## Send Payment {{title : 'Send Payment', label : 'lightning::payments::send_payment', tag : 'API-v2'}}
...
## Get Payment Details {{title : 'Get Payment Details', label : 'lightning::payments::get_payment_details', tag : 'API-v2'}}
...
## List Payments by Filter {{title : 'List Payments by Filter', label : 'lightning::payments::list_payments_by_filter', tag : 'API-v2'}}
