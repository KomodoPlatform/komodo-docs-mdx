...
| counterparty_channel_config_limits | object  | Optional. A standard [CounterpartyChannelConfig](/atomicdex/api/v20#counterparty-channel-options) object.       |
