...
The `enable_tendermint_token` method allows you to activate additional Tendermint assets. Before using this method, you first need to use the [enable\_tendermint\_with\_assets](/atomicdex/api/v20/enable_tendermint_with_assets) method.
...
<CodeGroup title="" tag="POST" label="enable_tendermint_token" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
