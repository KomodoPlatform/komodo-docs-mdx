...
| bch_addresses_infos    | object    | A standard [addressInfo](src/pages/atomicdex/common/common_structures#addressInfo) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| slp_addresses_infos    | object    | A standard [addressInfo](src/pages/atomicdex/common/common_structures#addressInfo) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
