...
| slp_tokens_requests    | array of objects | A list of standard [TokensRequest](/atomicdex/api/v20#TokensRequest) objects.                                                                                                                                                                                                                                                                                                              |
...
| tx_history             | boolean          | Optional, defaults to `true`. If `true` the AtomicDEX API will preload transaction history as a background process. Must be set to `true` to use the [my_tx_history](/atomicdex/api/legacy/my_tx_history#my-tx-history) method                                                                                                                                                                       |
...
| bch_addresses_infos    | object    | A standard [addressInfos](/atomicdex/api/v20#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| slp_addresses_infos    | object    | A standard [addressInfos](/atomicdex/api/v20#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
