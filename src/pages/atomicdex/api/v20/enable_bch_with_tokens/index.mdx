...
| slp_tokens_requests    | array of objects | A list of standard [TokensRequest](/atomicdex/api/v20#tokens-request) objects.                                                                                                                                                                                                                                                                                                              |
...
| bch_addresses_infos    | object    | A standard [addressInfos](/atomicdex/api/v20#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| slp_addresses_infos    | object    | A standard [addressInfos](/atomicdex/api/v20#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |


### 📌 Examples

#### Request with tx_history, cashaddress format, and automated utxo merging.
