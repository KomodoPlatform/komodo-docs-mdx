...
| slp_tokens_requests    | array of objects | A list of standard [TokensRequest](src/pages/atomicdex/api/v20#TokensRequest) objects.                                                                                                                                                                                                                                                                                                              |
...
| bch_addresses_infos    | object    | A standard [addressInfos](src/pages/atomicdex/api/v20#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| slp_addresses_infos    | object    | A standard [addressInfos](src/pages/atomicdex/api/v20#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
