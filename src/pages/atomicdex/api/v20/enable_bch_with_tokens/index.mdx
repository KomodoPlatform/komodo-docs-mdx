...
| bch\_addresses\_infos | object  | A standard [addressInfos](/atomicdex/api/common_structures/#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| slp\_addresses\_infos | object  | A standard [addressInfos](/atomicdex/api/common_structures/#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
