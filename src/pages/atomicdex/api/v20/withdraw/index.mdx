...
| fee       | object           | A standard [FeeInfo](/atomicdex/api/v20/#fee-info) object.                                     |
| from      | object           | HD wallets only. A standard [WithdrawFromInfo](/atomicdex/api/v20/#withdraw-from-info) object. |
