...
| tokens_params               | array of objects | A list of standard [TokensRequest](src/pages/atomicdex/api/v20#TokensRequest) objects.                                                                                                                                                                            |
...
| balance          | object           | Only returned when `get_balances` is `true`. A standard [BalanceInfos](src/pages/atomicdex/api/v20#BalanceInfos) object.                              |
| tokens_balances  | array of objects | Only returned when `get_balances` is `true`. A list of standard [addressInfos](src/pages/atomicdex/api/v20#addressInfos) objects, one for each token. |
