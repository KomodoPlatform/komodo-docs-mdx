...
| tokens\_params          | array of objects | A list of standard [TokensRequest](/atomicdex/api/v20#tokens-request) objects.                                                                                                                                                                                            |
...
| tokens\_balances | array of objects | Only returned when `get_balances` is `true`. A list of standard [addressInfos](/atomicdex/api/v20#address-infos) objects, one for each token. |
