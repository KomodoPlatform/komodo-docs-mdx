export const title = "AtomicDEX Method: Enable Tendermint Token with Assets";
...
| tokens_params               | array of objects | A list of standard [TokensRequest](/atomicdex/api/v20#tokens-request) objects.                                                                                                                                                                                               |
...
| balance          | object           | Only returned when `get_balances` is `true`. A standard [BalanceInfos](/atomicdex/api/v20#balance-infos) object.                              |
| tokens_balances  | array of objects | Only returned when `get_balances` is `true`. A list of standard [addressInfos](/atomicdex/api/v20#address-infos) objects, one for each token. |
