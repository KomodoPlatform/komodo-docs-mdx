...
| eth\_addresses\_infos   | object  | A standard [addressInfos](/atomicdex/api/common_structures/#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| erc20\_addresses\_infos | object  | A standard [addressInfos](/atomicdex/api/common_structures/#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
