...
| nodes.gui_auth                               | boolean          | Optional, defaults to `false`. Must be set to `true` to access nodes run officially by the Komodo Platform team                                                                                                                                                                                                                                 |
...
| eth_addresses_infos    | object    | A standard [addressInfo](src/pages/atomicdex/common/common_structures#addressInfo) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| erc20_addresses_infos  | object    | A standard [addressInfo](src/pages/atomicdex/common/common_structures#addressInfo) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
...
#### Request with `get_balance` set to false
