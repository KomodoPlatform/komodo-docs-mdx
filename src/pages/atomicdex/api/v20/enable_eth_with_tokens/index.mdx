...
| nodes                                        | array of objects | A list of standard [EvmNode](/atomicdex/api/v20#evm-node) objects.                                                                                                                                                                                                                                                                         |
| erc20_tokens_requests                        | array of objects | A list of standard [TokensRequest](/atomicdex/api/v20#tokens-request) objects.                                                                                                                                                                                                                                                                   |
...
| eth_addresses_infos    | object    | A standard [addressInfos](/atomicdex/api/v20#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| erc20_addresses_infos  | object    | A standard [addressInfos](/atomicdex/api/v20#address-infos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
