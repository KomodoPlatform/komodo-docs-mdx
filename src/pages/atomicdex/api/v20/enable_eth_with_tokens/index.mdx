...
| nodes                                        | array of objects | A list of standard [EvmNode](src/pages/atomicdex/common/structures#TokensRequest) objects.                                                                                                                                                                                                                                                                                              |
| erc20_tokens_requests                        | array of objects | A list of standard [TokensRequest](src/pages/atomicdex/common/structures#TokensRequest) objects.                                                                                                                                                                                                                                                 |
...
| tx_history                                   | boolean          | Optional, defaults to `false`. If `true` the AtomicDEX API will preload transaction history as a background process. Must be set to `true` to use the [my_tx_history](src/pages/atomicdex/api/legacy/my_tx_history#my-tx-history) method                                                                                                                  |
...
| eth_addresses_infos    | object    | A standard [addressInfos](src/pages/atomicdex/common/structures#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
| erc20_addresses_infos  | object    | A standard [addressInfos](src/pages/atomicdex/common/structures#addressInfos) object. Note: the structure may vary based on the value of the `get_balances` parameter. |
