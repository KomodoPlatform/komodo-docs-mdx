export const title = "AtomicDEX Method: Signing and Verifying Messages";
export const description = "This guide tells you about signing,verifying messages and error types.";
