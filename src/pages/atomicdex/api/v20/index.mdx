...
<Note>
  ...
  If not specified when using the [open\_channel](/atomicdex/api/v20-dev/lightning/channels/#open-a-channel) or [update\_channel](/atomicdex/api/v20-dev/lightning/channels/#update-a-channel) methods, the values in this object will default to the values set in the `coins` configuration file.
</Note>
