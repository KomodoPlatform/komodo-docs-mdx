...
| from\_date        | integer | Optional. A UNIX timestamp. If `true`, filter includes transfers from this date onwards (inclusive).                              |
| to\_date          | integer | Optional. A UNIX timestamp. If `true`, filter includes transfers up to this date (inclusive).                                     |
...
| image\_domain     | string                     | Optional. Extracted domain from the 'image_url', if valid.                                                                                                       |
