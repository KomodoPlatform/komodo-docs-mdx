...
| ---------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| balances               | object    | A standard [balanceInfos](/atomicdex/api/v20#balanceInfos) object. Not included in responses where `get_balances` is `false`  |
| derivation_method      | object    | A standard [DerivationMethod](/atomicdex/api/v20#DerivationMethod) object                                                    |
...
### `LightningChannelOptions` object
...
### `LightningOpenChannelsFilter` Object
...
### `LightningClosedChannelsFilter` Object
