...
| ---------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| balances               | object    | A standard [balanceInfos](src/pages/atomicdex/api/v20#balanceInfos) object. Not included in responses where `get_balances` is `false`  |
| derivation_method      | object    | A standard [DerivationMethod](src/pages/atomicdex/api/v20#DerivationMethod) object                                                    |
...
| Parameter     | Type   | Description                                                                                                               |
| ------------- | ------ | ------------------------------------------------------------------------------------------------------------------------- |
| type          | string | Possible values: `Iguana` <!-- TODO: insert more types here -->                                                           |
