...
| from\_date | string  | Optional. A UTC date string in the format `YYYY-MM-DD HH:MM:SS.SSS`. Only transfers after this date are included in the response.  |
| to\_date   | string  | Optional. A UTC date string in the format `YYYY-MM-DD HH:MM:SS.SSS`. Only transfers before this date are included in the response. |
...
| withdraw\_data | object | A standard [WithdrawDataErc721](/atomicdex/api/v20#withdraw-data-erc721) or [WithdrawDataErc1155](/atomicdex/api/v20#withdraw-data-erc155) object. |
