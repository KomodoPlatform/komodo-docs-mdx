...
The `enable_erc20` method allows you to activate additional ERC20 like tokens of a EVM type platform coin. Before using this method, you first need to use the [enable\_eth\_with\_tokens](/atomicdex/api/v20/enable_eth_with_tokens/) method.
...
<CodeGroup title="" tag="POST" label="enable_erc20">
