...
The `add_delegation` method initiates your node's staking of a compatible coin. Currently QTUM and tQTUM (test tokens avalable at [http://testnet-faucet.qtum.info/](http://testnet-faucet.qtum.info/)) have been integrated, but this functionality will be expanded to more coins in future.
