export const title = "KomoDeFi Method: My TX History";
...
For ZHTLC coins, you must use the [z\_coin\_tx\_history](/atomicdex/api/v20-dev/zhtlc_coins#z_coin_tx_history) method.
For all other coins, use the legacy [my\_tx\_history](/atomicdex/api/legacy/my_tx_history) method.
...
| target            | object  | Optional. A standard [HistoryTarget](/atomicdex/api/v20#history-target) object.                   |
