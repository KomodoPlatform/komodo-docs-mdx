...
export const description = "To use the get_raw_transaction method, ensure that your coin is activated tx_history with true";
...
For ZHTLC coins, you must use the [z_coin_tx_history](/atomicdex/api/v20-dev/zhtlc_coins#z_coin_tx_history) method.
For all other coins, use the legacy [my_tx_history](/atomicdex/api/legacy/my_tx_history) method.
