...
The `enable_slp` method allows you to activate additional SLP tokens. Before using this method, you first need to use the [enable\_bch\_with\_tokens](/atomicdex/api/v20/enable_bch_with_tokens) method.
...
<CodeGroup title="" tag="POST" label="enable_slp" mm2MethodDecorate="true">
  ```json
  {
