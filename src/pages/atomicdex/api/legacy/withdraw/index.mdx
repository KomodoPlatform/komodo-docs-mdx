...
This method generates a raw transaction which should then be broadcast using [send_raw_transaction](/atomicdex/api/legacy/send_raw_transaction.html).
...
#### Command (BTC, KMD, and other BTC-based forks, 1 DOC per Kbyte)
