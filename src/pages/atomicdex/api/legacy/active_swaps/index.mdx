...
| statuses    | object (map)     | Only visible if `include_status` request parameter is `true`. A map of standard [SwapStatus](/atomicdex/api/v20/#swap-status) objects, delineated by the related UUID. |
