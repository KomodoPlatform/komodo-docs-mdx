...
#### Command (select swaps uuids that have my_coin = DOC and other_coin = MARTY)
...
#### Command (select swaps uuids that have my_coin = DOC and started_at >= 1611705600 (January 27, 2021 0:00:00 GMT))
