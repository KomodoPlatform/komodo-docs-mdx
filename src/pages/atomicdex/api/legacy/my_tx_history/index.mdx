...
The coin that is used must have `tx_history` set to true in its [enable](/atomicdex/api/legacy/coin_activation/#enable-method) or [electrum](/atomicdex/api/legacy/coin_activation/#electrum-method) call.
