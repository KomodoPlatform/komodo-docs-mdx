export const title = "AtomicDEX Method: Import Swaps";
export const description = "The import_swaps method imports to the local database the swaps data that was exported from another AtomicDEX API instance.";
...
| --------- | ---------------- | -------------------------------------------------------------------------------------------- |
| swaps     | array of objects | A map of standard [SwapStatus](/atomicdex/api/common_structures/swaps/#swap-status) objects. |
...
<CodeGroup title="" tag="POST" label="import_swaps" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "method": "import_swaps",
