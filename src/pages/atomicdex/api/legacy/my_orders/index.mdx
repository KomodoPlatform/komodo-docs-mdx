export const title = "AtomicDEX Method: My Orders";
export const description = "The my_orders method returns the data of all active orders created by the AtomicDEX API node.";
...
<CodeGroup title="" tag="POST" label="my_orders" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "testpsw",
    "method": "my_orders"
