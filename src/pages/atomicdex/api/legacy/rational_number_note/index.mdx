export const title = "AtomicDEX Method: Rational Number Type";
export const description = "The AtomicDEX API now offers the num-rational crate feature. This is used to represent order volumes and prices.";
