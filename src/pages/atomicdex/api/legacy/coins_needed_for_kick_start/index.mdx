export const title = "AtomicDEX Method: Coins needed for kick Start";
export const description = "Learn how to kick-start interrupted swaps on the AtomicDEX API by activating the necessary coins using the coins_needed_for_kick_start method.";
