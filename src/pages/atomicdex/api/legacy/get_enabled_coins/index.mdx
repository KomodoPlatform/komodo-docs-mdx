export const title = "AtomicDEX Method: Get Enabled Coins";
export const description = "The get_enabled_coins method returns data of coins that are currently enabled on the user's AtomicDEX API node.";
...
<CodeGroup title="" tag="POST" label="get_enabled_coins">
