...
export const description = "The metrics method returns a snapshot of the current AtomicDEX API metrics used in Prometheus and Grafana.";
...
For more information check out the [AtomicDEX metrics guide](/atomicdex/api/tutorials/atomicdex-metrics)
