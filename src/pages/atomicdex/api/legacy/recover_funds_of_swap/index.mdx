export const title = "AtomicDEX Method: Recover Funds of Swap UUID";
export const description = "Learn how to recover funds from a swap-payment address in case of an error using the recover_funds_of_swap method in the AtomicDEX API.";
...
| result.tx\_hash | string | the hash of the recovering transaction                                                            |
| result.tx\_hex  | string | raw bytes of the recovering transaction in hexadecimal representation                             |

#### 📌 Examples

#### Command

<CodeGroup title="" tag="POST" label="recover_funds_of_swap">
