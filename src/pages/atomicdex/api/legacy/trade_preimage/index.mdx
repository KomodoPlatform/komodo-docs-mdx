...
| total\_fees               | array of objects | A standard [TotalFeeInfo](/atomicdex/api/common_structures/#total-fees) object. Each element is a sum of fees required to be paid from user's balance of corresponding `ExtendedFeeInfo.coin`; the elements are unique by coin |
