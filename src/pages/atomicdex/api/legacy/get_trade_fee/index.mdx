...
| result.amount\_rat      | rational         | the approximate fee amount to be paid per swap transaction in rational representation                                                                  |
| result.amount\_fraction | fraction         | the approximate fee amount to be paid per swap transaction in fraction representation                                                                  |

#### 📌 Examples

#### Command (BTC)

<CodeGroup title="" tag="POST" label="get_trade_fee">
