...
| Structure            | Type                           | Description                                                                                                                                                   |
| -------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| orders               | array of order objects         | Array of [OrderSummaryData](/atomicdex/api/common_structures/orders/#order-summary-data) that match the selected filters.                                     |
...
| details.order        | object                         | A standard [OrderDataV1](/atomicdex/api/common_structures/orders/#order-data-v1) objects containing outstanding asks                                                                                                                                      |
