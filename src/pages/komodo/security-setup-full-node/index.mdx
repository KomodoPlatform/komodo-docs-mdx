export const title = "Standard Security Setup for Nodes";
export const description =
  "This document describes all the steps to secure a server before using it as a KMD node.";
