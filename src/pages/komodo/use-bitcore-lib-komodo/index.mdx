export const title = "Using bitcore-lib-komodo";
export const description =
  "This document describes how to use bitcore-lib-komodo to generate KMD address privkey pair etc.";

# Using `bitcore-lib-komodo`

This is an example of using the Komodo flavour of `bitcore-lib`: [https://github.com/DeckerSU/bitcore-lib-komodo/](https://github.com/DeckerSU/bitcore-lib-komodo/)
