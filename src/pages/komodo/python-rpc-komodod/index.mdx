export const title = "RPC commands to komodod using python";
export const description =
  "This document describes how to access komodod's JSON-RPC interface using Python.";

# Access komodo daemons's JSON-RPC interface using Python
...
*   In general, there is no need to convert arguments to strings before they are passed in. But for the [cclib](/smart-chains/api/cclib/) methods, all the arguments need to be passed in as strings.
