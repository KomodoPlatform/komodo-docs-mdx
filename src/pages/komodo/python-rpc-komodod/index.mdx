...
*   In general, there is no need to convert arguments to strings before they are passed in. But for the [cclib](/smart-chains/api/cclib.html) methods, all the arguments need to be passed in as strings.
