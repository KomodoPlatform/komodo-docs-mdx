export const title = "Changes to Komodo Blockchain at Block Height 1 Million";
export const description =
  "When the Komodo Blockchain reached the Block Height 1000000 in the first half of September 2018, two notable changes happened.";
