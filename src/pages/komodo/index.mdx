export const title = "Building Komodo from source";
export const description =
  "This document describes the steps to install the Komodo daemon on Ubuntu, OSX and Windows.";

# Building Komodo from source

For OSx instructions: see [Installing Komodo on OSX](/komodo/#installing-komodo-on-osx)

For Windows instructions: see [Installing Komodo on Windows 64-bit systems](/komodo/#installing-komodo-on-windows-64-bit-systems)
...
*   For Ubuntu, we recommend using only the 20.04+ releases
...
PLEASE FOLLOW THE VIDEO TUTORIAL: [https://www.youtube.com/watch?v=gfZZy8b222E](https://www.youtube.com/watch?v=gfZZy8b222E)
