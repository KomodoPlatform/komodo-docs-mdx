...
import rustupMinimal from "@/public/images/setup/rustup-minimal.png";
...
The AtomicDEX API executable is now built and available here: `~/komodo-defi-framework/target/debug/mm2`
