export const title = "KDF Method: Telegram Alerts for Bot Trading | Gleec";
...
## Overview {{label : 'telegram_alerts', tag : 'overview'}}
...
<CompactTable source="v2/utils.TelegramAlertsConfig" />
