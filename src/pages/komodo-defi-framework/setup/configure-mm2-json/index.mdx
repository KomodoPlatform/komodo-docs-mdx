...
| ------------------------------- | --------------- | :------: | :---------------------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1inch\_api                      | string          |     ✗    |           `-`           | Required if using [1inch integration methods](/komodo-defi-framework/api/v20-dev/one_inch_v6_0_classic_swap_create/). URL for 1inch API, e.g. "[https://api.1inch.dev](https://api.1inch.dev)"                                                                                                                                                                                                                       |
