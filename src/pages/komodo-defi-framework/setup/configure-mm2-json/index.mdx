...
| gas\_api                     | object          | Optional, Used for [EVM gas fee management](/komodo-defi-framework/api/v20/fee_management/). Contains fields for `provider` and `url` to source third party fee market information.                                                                                                                                                                                                                                                   |
