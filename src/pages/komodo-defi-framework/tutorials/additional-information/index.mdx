export const title = "Additional Information About AtomicDEX";
export const description = "The AtomicDEX API is built to have a core component that can serve many front-end graphical-user interfaces (GUIs).";
