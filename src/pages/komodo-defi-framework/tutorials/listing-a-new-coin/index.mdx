...
| protocol   | object  |    ✓     | A standard [TokenProtocol](/komodo-defi-framework/api/common_structures/#token-protocol) object. Platform / protocol - e.g `ETH` for Ethereum, `ERC20` for ERC20 tokens on the Ethereum network. See examples below for structure.                                                                                                      |
