...
| ---------------- | ------- | :------: | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| order\_type      | string  |     ✗    | A standard [OrderType](/komodo-defi-framework/api/common_structures/#order-type-enum) enum. Return only orders that match the `order_type`               |
...
| status           | string  |     ✗    | A standard [OrderStatus](/komodo-defi-framework/api/common_structures/#order-status-enum) enum. Return only orders that match the `status`               |
