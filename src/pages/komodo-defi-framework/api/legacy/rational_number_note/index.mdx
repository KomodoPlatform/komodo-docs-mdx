export const title = "KDF Legacy: Rational Number Type | Gleec";
export const description = "Learn how the Komodo DeFi Framework API's num-rational crate feature precisely represents order volumes and prices";
