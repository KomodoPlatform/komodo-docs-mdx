...
| Parameter | Type   | Description                                                                                                                                               |
| --------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| type      | string | A standard [MetricType](/komodo-defi-framework/api/common_structures/#metric-type-enum) enum which indicates how it should be displayed in visualisation. |
