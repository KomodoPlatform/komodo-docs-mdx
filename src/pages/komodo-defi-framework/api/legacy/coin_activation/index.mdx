...
| servers                                  | array of objects                        | List of [Electrum servers] 
(*Check out for full and update nodes/servers list: https://github.com/KomodoPlatform/coins/tree/master/electrums)  |
