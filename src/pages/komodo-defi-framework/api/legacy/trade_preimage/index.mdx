...
| swap\_method | string                     |     ✓    |    -    | A standard [SwapMethodEnum](/komodo-defi-framework/api/common_structures/#swap-method-enum) enum. The name of the method whose preimage is requested. |
