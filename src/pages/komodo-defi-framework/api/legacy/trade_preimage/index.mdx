export const title = "KDF Legacy Method: Trade Preimage | Gleec";
export const description = "The legacy trade_preimage method estimates the approximate fees paid for a complete atomic swap";
