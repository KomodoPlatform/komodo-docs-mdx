...
| unban\_by.type | string |     ✓    |    -    | A standard [UnbanTypeEnum](/komodo-defi-framework/api/common_structures/#unban-type-enum) enum. Whether to unban all pubkeys or specific ones from a list |
