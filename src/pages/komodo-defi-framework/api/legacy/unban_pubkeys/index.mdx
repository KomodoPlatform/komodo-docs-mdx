...
| unban\_by.type | string |     ✓    |    -    | A standard [UnbanType](/komodo-defi-framework/api/common_structures/#unban-type-enum) enum. Whether to unban all pubkeys or specific ones from a list |
