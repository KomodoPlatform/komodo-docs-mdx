export const title = "KDF Legacy Method: My TX History Docs | Gleec";
...
<CompactTable source="legacy/wallet.MyTxHistoryRequest" />

## Response

<CompactTable source="legacy/wallet.MyTxHistoryResponse" />

#### 📌 Examples

#### Command

<CodeGroup title="" tag="POST" label="my_tx_history" mm2MethodDecorate="true" source="legacy/wallet.MyTxHistoryDoc" />

#### Command (max = true)

<CodeGroup title="" tag="POST" label="my_tx_history" mm2MethodDecorate="true" source="legacy/wallet.MyTxHistoryDocMax" />

<CollapsibleSection expandedText="Hide Response" collapsedText="Show Response">
  #### Response (success)

  <KdfResponses responseKey="legacy/wallet.MyTxHistoryDoc" />

  #### Response (Sync in progress for UTXO coins)

  <KdfResponses responseKey="legacy/wallet.MyTxHistorySyncUtxoInProgress" />

  #### Response (Sync in progress for ETH/ERC20 coins)

  <KdfResponses responseKey="legacy/wallet.MyTxHistorySyncEthInProgress" />
...
<CodeGroup title="" tag="POST" label="my_tx_history" mm2MethodDecorate="true" source="legacy/wallet.MyTxHistorySia" />

<CollapsibleSection expandedText="Hide Response" collapsedText="Show Response">
  <KdfResponses responseKey="legacy/wallet.MyTxHistorySia" />
</CollapsibleSection>
...
<CollapsibleSection expandedText="Hide Error Responses" collapsedText="Show Error Responses">
  ...
  <KdfResponses responseKey="legacy/wallet.MyTxHistoryErrors" />
