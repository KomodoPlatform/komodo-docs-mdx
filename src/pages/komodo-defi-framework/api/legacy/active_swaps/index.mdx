...
<Note>
This method has been deprecated in favor of (active_swaps v2)[/komodo-defi-framework/api/v20/active_swaps]. The legacy version does not include v2 (Trading Protocol Upgrade) swap statuses in responses (it only returns uuids for these).
</Note>
