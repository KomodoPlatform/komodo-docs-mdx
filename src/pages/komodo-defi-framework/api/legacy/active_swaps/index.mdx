...
# Komodo DeFi Framework Method: Active Swaps

## active\_swaps {{label: 'active_swaps', tag: 'API-v1'}}
...
| --------------- | ---- | :------: | :-----: | --------------------------------------------- |
| include\_status | bool |     ✗    | `false` | Whether to include swap statuses in response. |
