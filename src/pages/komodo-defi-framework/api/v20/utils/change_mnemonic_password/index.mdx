...
| ----------------- | ------ | ------------------------------------------------------------ |
| current\_password | string | the currently set mnemonic password                          |
| new\_password     | string | the new password to use for encrypting the mnemonic password |
...
<Note>
  You can use the password with the [get\_mnemonic](/komodo-defi-framework/api/v20/utils/get_mnemonic/#get-mnemonic) method to view the mnemonic phrase in plain text.
</Note>
