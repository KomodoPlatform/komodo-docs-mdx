export const title = "KDF Method: Trezor Init Task Status | Gleec";
...
<CompactTable source="v2/utils.TaskInitTrezorStatusRequest" />

### Response Parameters

<CompactTable source="v2/utils.TaskInitTrezorStatusResponse" />
