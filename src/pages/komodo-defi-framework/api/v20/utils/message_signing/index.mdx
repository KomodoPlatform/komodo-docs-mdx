...
# Komodo DeFi Framework Method: Signing and Verifying Messages

## Overview {{label : 'message_signing', tag : 'API-v2'}}
...
<DevComment>
  This is an overview page. Individual method documentation is in the sign\_message and verify\_message folders.
</DevComment>
