...
| --------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| filter          | Object | [FilterCriteria](/komodo-defi-framework/api/common_structures/#filter-criteria) containing all the filtering criteria for the swaps    |
| paging\_options | Object | [PagingOptionsObject](/komodo-defi-framework/api/common_structures/#paging-options) containing all the paging options for the request. |
