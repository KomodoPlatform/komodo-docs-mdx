...
# Best Orders {{label : 'best_orders', tag : 'API-v2'}}
...
| ------------- | ------ | :------: | :-----: | ------------------------------------------------------------------------------------------------------------------------------------- |
| action        | string | ✓        | -       | A standard [ActionEnum](/komodo-defi-framework/api/common_structures/#action-enum) enum. Whether to `buy` or `sell` the selected coin |
