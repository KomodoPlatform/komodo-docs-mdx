...
| cfg.name.max\_volume.percentage                          | string  |    ✗     |   `-`   | Percentage of balance to trade (can not use at same time as `max_volume.usd`; if greater than 1.0 `max=true` is implied)                                                                                                                                                                     |
| cfg.name.max\_volume.usd                                 | string  |    ✗     |   `-`   | Maximum USD trade volume value to trade (can not use at same time as `max_volume.percentage`; if greater than full balance `max=true` is implied)                                                                                                                                            |
| cfg.name.min\_volume.percentage                          | string  |    ✗     |   `-`   | Minimum percentage of balance to accept in trade (can not use at same time as `min_volume.usd`)                                                                                                                                                                                              |
| cfg.name.min\_volume.usd                                 | float   |    ✗     |   `-`   | Minimum USD trade volume of trades accepted for order (can not use at same time as `min_volume.percentage`)                                                                                                                                                                                  |
