export const title = "KDF v2 Method: Trade Preimage | Gleec";
export const description = "The v2 trade_preimage method estimates the approximate fees paid for a complete atomic swap";
