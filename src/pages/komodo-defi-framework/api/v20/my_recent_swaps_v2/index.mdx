...
| --------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| filter          | Object                        | [FilterCriteria](/komodo-defi-framework/api/common_structures/#FilterCriteria) containing all the filtering criteria for the swaps                 |
| paging\_options | Object                        | [PagingOptionsObject](/komodo-defi-framework/api/common_structures/#PagingOptions) containing all the paging options for the request. 	  	|
