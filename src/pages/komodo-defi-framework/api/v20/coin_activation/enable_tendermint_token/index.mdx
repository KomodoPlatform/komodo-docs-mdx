...
# Komodo DeFi Framework Method: enable\_tendermint\_token
...
| activation\_params | object |     ✗    |    -    | A standard [TokenActivationParams](/komodo-defi-framework/api/common_structures/nfts/#token-activation-params) object. |
