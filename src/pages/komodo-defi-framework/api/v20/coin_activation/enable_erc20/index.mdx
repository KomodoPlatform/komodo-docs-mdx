...
export const description =
  "The enable_erc20 method allows you to activate additional ERC20 like tokens of an EVM type platform coin, including TRC20 tokens on TRON.";

# enable\_erc20

The `enable_erc20` method allows you to activate additional ERC20 like tokens of an EVM type platform coin, including TRC20 tokens on TRON. Before using this method, you first need to use the [enable\_eth\_with\_tokens](/komodo-defi-framework/api/v20/coin_activation/enable_eth_with_tokens/) method to activate the platform coin (e.g. ETH, MATIC, TRX).
