...
# Komodo DeFi Framework Method: Enable ETH with Tokens
...
| priv\_key\_policy           | string           |     ✗    |   ContextPrivKey  | Value can be [EthPrivKeyActivationPolicyEnum](/komodo-defi-framework/api/common_structures/enums/#eth-priv-key-activation-policy-enum).                                                                                                           |
