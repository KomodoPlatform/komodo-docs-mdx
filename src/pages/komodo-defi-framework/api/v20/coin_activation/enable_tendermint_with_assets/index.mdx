...
| activation_params       | object           | Optional, only used with Metamask, Keplr or WalletConnect activations. Defines the `session_topic` of the connection, under `wallet_connect.session_topic`.
