...
<CodeGroup title="task::enable_tendermint::user_action" tag="POST" label="task::enable_tendermint::user_action" mm2MethodDecorate="true" source="v2/coin_activation.TaskEnableTendermintUserAction" />
