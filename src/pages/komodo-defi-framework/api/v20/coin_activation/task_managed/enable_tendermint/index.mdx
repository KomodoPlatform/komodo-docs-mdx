export const title = "Komodo DeFi Framework Method: Enable Tendermint Task";
export const description = "Overview of task managed activation methods for Tendermint coins like ATOM, OSMO, and IRIS.";

# Enable Tendermint Task

## task::enable\_tendermint {{label : 'task::enable_tendermint', tag : 'API-v2'}}
