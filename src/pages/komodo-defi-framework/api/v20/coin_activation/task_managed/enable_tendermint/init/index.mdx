...
## task::enable_tendermint::init {{label : 'task::enable_tendermint::init', tag : 'API-v2'}}
...
| tokens_params           | array of objects |     ✗    |        -       | A list of standard [TokensRequest](/komodo-defi-framework/api/common_structures/activation/#tokens-request) objects.                                                                                                                     |
