...
| tendermint\_node\_urls  | array of strings |     ✗    |    -    | A list of Tendermint node URLs, used for validation of transactions. It's recommended to add as many servers as possible. The URLs list can be found at [https://tendermintnodes.com/](https://tendermintnodes.com/).    |
| tokens\_requests        | array of objects |     ✗    |    -    | A list of standard [TokensRequest](/komodo-defi-framework/api/common_structures/activation/#tokens-request) objects.                                                                                                     |
...
| allow\_unsafe\_conf     | boolean          |     ✗    | `false` | If true, allows tendermint\_node\_urls to be empty. **Warning:** it is highly unsafe to do so as it may lead to invalid transactions generation and tokens burning.                                                      |
...
| requires\_notarization  | boolean          |     ✗    |  `true` | Has no effect on Tendermint.                                                                                                                                                                                             |
