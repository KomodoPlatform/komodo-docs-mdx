...
## init {{label : 'task::enable_bch::init', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="task::enable_bch::init" mm2MethodDecorate="true">
  ```json
  {
...
## status {{label : 'task::enable_bch::status', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="task::enable_bch::status" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
## user\_action {{label : 'task::enable_bch::user_action', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="task::enable_bch::user_action" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
## cancel {{label : 'task::enable_bch::cancel', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="task::enable_bch::cancel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
