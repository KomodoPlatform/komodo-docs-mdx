export const title = "Komodo DeFi Framework Method: EVM Coin Activation Tasks";
export const description = "Overview of task managed activation methods for EVM coins like ETH, AVAX, BNB, and Polygon.";

# Komodo DeFi Framework Method: EVM Coin Activation Tasks

## task::enable\_eth {{label : 'task::enable_eth', tag : 'API-v2'}}
