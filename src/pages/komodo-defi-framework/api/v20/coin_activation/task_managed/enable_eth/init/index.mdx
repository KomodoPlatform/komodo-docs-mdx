...
| ------------------------ | ---------------- | :------: | :-----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ticker                   | string           |     ✓    |    -    | Ticker of the ETH-based coin you want to enable.                                                                                                                                                                         |
| mode                     | object           |     ✓    |    -    | A standard [ActivationMode](/komodo-defi-framework/api/common_structures/activation/#activation-mode) object.                                                                                                            |
| eth\_node\_urls          | array of strings |     ✗    |    -    | A list of ETH node URLs, used for validation of EVM token transactions. It's recommended to add as many servers as possible. The URLs list can be found at [https://ethnodes.com/](https://ethnodes.com/).               |
| evm\_tokens\_requests    | array of objects |     ✗    |    -    | A list of standard [TokensRequest](/komodo-defi-framework/api/common_structures/activation/#tokens-request) objects.                                                                                                     |
...
| allow\_evm\_unsafe\_conf | boolean          |     ✗    | `false` | If true, allows eth\_node\_urls to be empty. **Warning:** it is highly unsafe to do so as it may lead to invalid EVM transactions generation and tokens burning.                                                         |
...
| requires\_notarization   | boolean          |     ✗    |  `true` | Has no effect on ETH.                                                                                                                                                                                                    |
