...
<CodeGroup title="task::enable_qtum::user_action" tag="POST" label="task::enable_qtum::user_action" mm2MethodDecorate="true" source="v2/coin_activation.TaskEnableQtumUserAction" />
