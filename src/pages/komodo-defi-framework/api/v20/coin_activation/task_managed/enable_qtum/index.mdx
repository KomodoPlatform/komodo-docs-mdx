export const title = "Komodo DeFi Framework Method: QTUM Coin Activation Tasks";
export const description = "Overview of task managed activation methods for QTUM ecosystem coins.";

# Komodo DeFi Framework Method: QTUM Coin Activation Tasks

## task::enable\_qtum {{label : 'task::enable_qtum', tag : 'API-v2'}}
