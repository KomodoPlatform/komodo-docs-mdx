export const title = "Komodo DeFi Framework Method: Enable UTXO Task";
export const description = "Overview of task managed activation methods for UTXO coins like KMD, LTC, BTC & DOGE.";

# Enable UTXO Task

## task::enable\_utxo {{label : 'task::enable_utxo', tag : 'API-v2'}}

This section provides an overview of the task managed activation methods for UTXO coins like KMD, LTC, BTC & DOGE. Each method is documented in its own dedicated page:
