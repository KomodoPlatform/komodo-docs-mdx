...
# Komodo DeFi Framework Method: UTXO Coin Activation Tasks
...
<CodeGroup title="task::enable_utxo::user_action" tag="POST" label="task::enable_utxo::user_action" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
