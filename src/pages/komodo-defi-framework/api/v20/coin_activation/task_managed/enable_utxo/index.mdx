...
<CodeGroup title="task::enable_utxo::user_action" tag="POST" label="task::enable_utxo::user_action" mm2MethodDecorate="true" source="v2/coin_activation.TaskEnableUtxoUserAction" />
