export const title = "Komodo DeFi Framework Method: Enable BCH Task";
export const description = "Overview of task managed activation methods for BCH and SLP tokens.";

# Enable BCH Task

## task::enable\_bch {{label : 'task::enable_bch', tag : 'API-v2'}}

This section provides an overview of the task managed activation methods for BCH and SLP tokens. Each method is now documented in its own dedicated page:
