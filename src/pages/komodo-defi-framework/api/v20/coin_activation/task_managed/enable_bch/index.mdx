...
<CodeGroup title="task::enable_bch::user_action" tag="POST" label="task::enable_bch::user_action" mm2MethodDecorate="true" source="v2/coin_activation.TaskEnableBchUserAction" />
