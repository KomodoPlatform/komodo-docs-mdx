export const title = "Komodo DeFi Framework Method: ZHTLC Coin Activation Tasks";
export const description = "Overview of task managed activation methods for ZHTLC coins like ARRR & ZOMBIE.";

# Komodo DeFi Framework Method: ZHTLC Coin Activation Tasks

## task::enable\_z\_coin {{label : 'task::enable_z_coin', tag : 'API-v2'}}
