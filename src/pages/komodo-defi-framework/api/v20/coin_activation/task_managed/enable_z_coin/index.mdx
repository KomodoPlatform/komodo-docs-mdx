...
<CodeGroup title="task::enable_z_coin::user_action" tag="POST" label="task::enable_z_coin::user_action" mm2MethodDecorate="true" source="v2/coin_activation.TaskEnableZCoinUserAction" />
