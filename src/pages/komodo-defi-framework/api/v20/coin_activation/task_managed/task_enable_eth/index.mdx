...
## init {{label : 'task::enable_eth::init', tag : 'API-v2'}}

"The methods in this document demonstrate the activation of ETH/EVM coins and tokens in a task managed manner.";
...
| ticker                  | string  | Ticker of the platform protocol coin. Options: `ETH`, `AVAX`, `BNB`, `FTM`, `MATIC`, `ONE`, `ETH-ARB20`                                                                                                                                                                                                                                      |
| wallet_balance          | object  | A standard [WalletBalanceInfo](/komodo-defi-framework/api/common_structures/#wallet-balance-info) object. Note: the structure may vary based on the `get_balances` parameter value in the acttivation request.                                                                                                                                                                                                                                     |
...
<CodeGroup title="" tag="POST" label="task::enable_eth::init" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "{{userpass}}",
    "mmrpc": "2.0",
...
## status {{label : 'task::task_enable_eth::status', tag : 'API-v2'}}

After running the `task::task_enable_eth::init` method, we can query the status of activation to check its progress.
...
<CodeGroup title="" tag="POST" label="task::task_enable_eth::status" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
    "method": "task::task_enable_eth::status",
    "params": {
      "task_id": 1,
...
## user\_action {{label : 'task::task_enable_eth::user_action', tag : 'API-v2'}}

If the `task::task_enable_eth::status` returns `UserActionRequired`, we need to use the `task::task_enable_eth::user_action` method to enter our PIN
...
<CodeGroup title="" tag="POST" label="task::task_enable_eth::user_action" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
    "method": "task::task_enable_eth::user_action",
    "params": {
      "task_id": 0,
      "user_action": {
...
## cancel {{label : 'task::task_enable_eth::cancel', tag : 'API-v2'}}
...
<CodeGroup title="" tag="POST" label="task::task_enable_eth::cancel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "method": "task::task_enable_eth::cancel",
    "mmrpc": "2.0",
    "params": {
      "task_id": 3
    }
