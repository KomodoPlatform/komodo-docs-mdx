export const title = "Komodo DeFi Framework Method: Withdraw Task";
export const description = "Overview of withdraw task-managed methods in the Komodo DeFi Framework API.";

# Withdraw Task

## task::withdraw {{label : 'task::withdraw', tag : 'API-v2'}}
...
<DevComment>
  TODO: Add summary for each withdraw task-managed method, and cross-link to related wallet and transaction docs.
</DevComment>
