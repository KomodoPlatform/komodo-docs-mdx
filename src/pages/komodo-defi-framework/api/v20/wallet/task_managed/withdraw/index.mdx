...
<Note>
  ...
  SIA protocol coins should use the v1 [withdraw](/komodo-defi-framework/api/legacy/withdraw/#withdraw) method, or the non-task v2 [withdraw](/komodo-defi-framework/api/v20/wallet/tx/withdraw/#withdraw) method.
</Note>
