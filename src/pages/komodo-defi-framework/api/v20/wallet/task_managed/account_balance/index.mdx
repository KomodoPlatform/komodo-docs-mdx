export const title = "Komodo DeFi Framework Method: task::account_balance";
...
# Komodo DeFi Framework Method: task::account\_balance

## task::account\_balance {{label : 'task::account_balance', tag : 'API-v2'}}
...
<DevComment>
  TODO: Add summary for each account balance method, and cross-link to related HD wallet docs.
</DevComment>
