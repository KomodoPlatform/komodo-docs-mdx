export const title = "Komodo DeFi Framework Method: task::create_new_account::user_action";
...
# Komodo DeFi Framework Method: task::create\_new\_account::user\_action
