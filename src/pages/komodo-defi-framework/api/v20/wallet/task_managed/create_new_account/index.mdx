...
| account\_id | string |     ✗    |   `-`   | If not defined, will increment to the next unused account id in the wallet.                                                   |
| scan        | string |     ✗    |  `true` | If `true`, will scan the account for funded addresses.                                                                        |
| gap\_limit  | string |     ✗    |   `20`  | The maximum number of empty addresses in a row. Defaults to the value provided on activation, or 20 if no value was provided. |
