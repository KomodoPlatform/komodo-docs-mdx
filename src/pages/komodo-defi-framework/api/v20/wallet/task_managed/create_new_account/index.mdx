...
<CodeGroup title="Create New Account Init" tag="POST" label="task::create_new_account::init" mm2MethodDecorate="true">
  ```json
  {
...
<CollapsibleSection expandedText="Hide Create New Account Init Response" collapsedText="Show Create New Account Init Response">
