export const title = "Komodo DeFi Framework Method: task::scan_for_new_addresses";
export const description = "Overview of scan for new addresses task-managed methods in the Komodo DeFi Framework API.";

# Komodo DeFi Framework Method: task::scan\_for\_new\_addresses

## task::scan\_for\_new\_addresses {{label : 'scan_for_new_addresses', tag : 'API-v2'}}
...
<DevComment>
  TODO: Add summary for each scan\_for\_new\_addresses method, and cross-link to related HD wallet docs.
</DevComment>
