...
<CodeGroup title="" tag="POST" label="task::get_new_address::init" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
<CodeGroup title="Status" tag="POST" label="task::get_new_address::status" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
<CodeGroup title="User Action" tag="POST" label="task::get_new_address::user_action" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
<CodeGroup title="Cancel" tag="POST" label="task::get_new_address::cancel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
