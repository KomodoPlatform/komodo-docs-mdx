export const title = "KDF Method: Get Swap Transaction Fee Policy | Gleec";
export const description =
  "The get_swap_transaction_fee_policy method returns the current gas fee policy used to estimate swap fees for ETH/EVM coins";
