export const title = "Komodo DeFi Framework Method: lightning::nodes::remove_trusted_node";
export const description = "Remove a trusted Lightning node using the Komodo DeFi Framework API.";

# Komodo DeFi Framework Method: lightning::nodes::remove\_trusted\_node
...
<CodeGroup title="lightning::nodes::remove_trusted_node" tag="POST" label="lightning::nodes::remove_trusted_node" mm2MethodDecorate="true">
  ```json
  {
