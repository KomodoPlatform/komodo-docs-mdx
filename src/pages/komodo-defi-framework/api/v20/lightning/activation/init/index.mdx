export const title = "Initialize Lightning";
export const description = "Request a task to run a lightning node on Komodo DeFi Framework.";
...
| activation_params  | object |     ✓    | A standard [LightningActivationParams](/komodo-defi-framework/api/common_structures/lightning/#lightning-activation-params) object. |
