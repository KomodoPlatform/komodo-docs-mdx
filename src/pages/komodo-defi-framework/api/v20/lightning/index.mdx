...
# Komodo DeFi Framework Method: Lightning Network Methods
...
*   Initialize your lightning node with [task::enable\_lightning::init](/komodo-defi-framework/api/v20/lightning/activation/#initialize-lightning)
