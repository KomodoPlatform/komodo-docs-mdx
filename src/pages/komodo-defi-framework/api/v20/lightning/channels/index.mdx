...
# Komodo DeFi Framework Method: Lightning Network Channels
...
<CollapsibleSection expandedText="Hide Open Channel (Exact Amount) Response" collapsedText="Show Open Channel (Exact Amount) Response">
  #### Response
...
<CollapsibleSection expandedText="Hide Open Channel (Max Amount with Options) Response" collapsedText="Show Open Channel (Max Amount with Options) Response">
  #### Response
...
| force\_close | boolean |     ✗    | `false` | If `true`, will force closure of the channel.                 |
...
<CodeGroup title="Close Channel" tag="POST" label="close_channel" mm2MethodDecorate="true">
  ```json
  {
    "userpass": "RPC_UserP@SSW0RD",
    "mmrpc": "2.0",
...
<CollapsibleSection expandedText="Hide Close Channel Error Responses" collapsedText="Show Close Channel Error Responses">
  #### ⚠️ Error Responses
