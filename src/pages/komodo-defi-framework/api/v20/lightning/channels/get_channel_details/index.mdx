export const title = "Komodo DeFi Framework Method: lightning::channels::get_channel_details";
export const description = "Get details about a Lightning Network channel using the Komodo DeFi Framework API.";

# Komodo DeFi Framework Method: lightning::channels::get\_channel\_details
