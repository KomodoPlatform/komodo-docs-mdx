export const title = "Komodo DeFi Framework Method: lightning::payments::get_payment_details";
export const description = "Get details of a Lightning Network payment using the Komodo DeFi Framework API.";

# Komodo DeFi Framework Method: lightning::payments::get\_payment\_details
...
| payment\_hash | string |     ✓    | The hash of the payment to query.       |
