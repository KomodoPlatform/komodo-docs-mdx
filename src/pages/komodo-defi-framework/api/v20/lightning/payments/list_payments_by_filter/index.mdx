export const title = "Komodo DeFi Framework Method: lightning::payments::list_payments_by_filter";
export const description = "List Lightning Network payments by filter using the Komodo DeFi Framework API.";

# Komodo DeFi Framework Method: lightning::payments::list\_payments\_by\_filter
...
| --------------- | ------- | :------: | ------------------------------------------ |
| coin            | string  |     ✓    | The ticker of the coin for the payments.   |
| filter          | object  |     ✗    | A standard LightningPaymentsFilter object. |
| paging\_options | object  |     ✗    | A standard Pagination object.              |
