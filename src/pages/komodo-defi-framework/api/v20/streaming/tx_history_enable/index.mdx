export const title = "KDF Method: Enable Tx History Streaming | Gleec";
...
<CompactTable source="v2/streaming.TxHistoryEnableRequestParameters" />
...
<CompactTable source="v2/streaming.TxHistoryEnableResponseParameters" />

#### 📌 Examples

<CodeGroup title="tx_history_enable" tag="POST" label="tx_history_enable" mm2MethodDecorate="true">
  ```json
  {
...
<CompactTable source="v2/streaming.TxHistoryEnableErrorTypes" />
