...
## streaming::tx\_history\_enable {{label : 'streaming::tx_history_enable', tag : 'API-v2'}}
...
| client\_id | integer |     ✗    |   `0`   | This ID can be used to access data via [http://localhost:7783/event-stream?id=1](http://localhost:7783/event-stream?id=1) |
