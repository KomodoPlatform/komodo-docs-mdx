...
# Komodo DeFi Framework Method: Enable NFT
...
| ------------------ | ------ | :------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ticker             | string |     ✓    | The ticker of the NFT network, with `NFT_` as a prefix. See [NftNetworkEnum](/komodo-defi-framework/api/common_structures/#nft-network-enum) for allowed values. |
