...
| ---------- | ------- | :------: | :-----: | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| chains     | array   |     ✗    |   `-`   | List of networks to remove NFT data for. See [NftNetworkEnum](/komodo-defi-framework/api/common_structures/#nft-network-enum) for allowed values. |
