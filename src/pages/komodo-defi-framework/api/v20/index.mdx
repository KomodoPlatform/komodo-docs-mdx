...
| tx\_history                  | boolean | Optional. Enable transaction history scanning. When active, the KomoDefi API will collect transaction history data for local storage, and allow use of the [my\_tx\_history (v2)](/komodo-defi-framework/api/v20/my_tx_history/) method.                                                  |
