...
| request\_by   | object | A standard [RequestBy](/atomicdex/api/common_structures/orders/#request-by) object.  |

#### Response

| Structure         | Type          | Description                                                                                                    |
| ----------------- | ------------- | -------------------------------------------------------------------------------------------------------------- |
| orders            | object (map)  | the `ticker -> array of standard [OrderData](/atomicdex/api/common_structures/orders/#order-data) objects` map |
