...
| nodes                       | array of objects | A list of standard [EvmNode](/komodo-defi-framework/api/common_structures/activation/#evm-node) objects. (https://github.com/KomodoPlatform/coins/tree/master/electrums).
                                                                                                                                                                                                                                   |
