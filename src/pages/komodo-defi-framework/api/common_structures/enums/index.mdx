...
export const description = "Explore the enum data types used across Komodo DeFi Framework API responses, following the mmrpc 2.0 protocol standard";
...
Used in Lightning Network [get\_channel\_details](/komodo-defi-framework/api/v20/lightning/channels/) response to indicate channel status:
...
Used in Lightning Network channel filter methods for [list\_open\_channels\_by\_filter](/komodo-defi-framework/api/v20/lightning/channels/) and [list\_closed\_channels\_by\_filter](/komodo-defi-framework/api/v20/lightning/channels/):
