export const title = "KDF Common Structures: Rational Number | Gleec";
export const description = "See the rational number data structure used by the Komodo DeFi Framework API to represent order volumes and prices";
