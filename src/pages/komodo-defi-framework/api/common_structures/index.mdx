...
| Parameter                 | Type    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| stream\_interval\_seconds | float   | Optional, defaults to `10` for balance events and `5` for network/heartbeat events. Interval in seconds between streaming event update requests.                                                                                                                                                                                                                                                                                                                                                                    |
| estimate\_every           | float   | [stream::fee\_estimator::enable](/komodo-defi-framework/api/v20/streaming/fee_estimator/) only. Defaults to `15`. Interval in seconds between fee estimate updates.                                                                                                                                                                                                                                                                                                                                                 |
| estimate\_type            | string  | [stream::fee\_estimator::enable](/komodo-defi-framework/api/v20/streaming/fee_estimator/) only. Defaults to `Simple`. If set to `Provider`, users must set the `gas_api` setting in their [MM2.json file](/komodo-defi-framework/setup/configure-mm2-json/) to source recommended fee values from third party providers [Infura](https://www.infura.io/) or [Blocknative](https://www.blocknative.com/) Used in [get\_eth\_estimated\_fee\_per\_gas](/komodo-defi-framework/api/v20/streaming/fee_estimator/) only. |
...
An example of the event stream output can then be viewed in [https://github.com/KomodoPlatform/komodo-defi-framework/blob/main/examples/sse/index.html?id=1](https://github.com/KomodoPlatform/komodo-defi-framework/blob/main/examples/sse/index.html?id=1)

The `CLIENT_ID` value used in the url must match the `client_id` value used when enabling streaming events.
