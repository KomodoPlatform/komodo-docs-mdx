...
Used in [kmd_rewards_info](/komodo-defi-framework/api/legacy/kmd_rewards_info/) responses to represent either accrued reward amounts or the reason why rewards were not accrued.
