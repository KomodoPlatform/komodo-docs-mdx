...
| validator_address  | string  | The address of the validator to delegate staking to.                                  |
| amount             | string  | The amount of coins to stake send to the validator for delegated staking.                                  |
