...
| gas\_price                   | decimal | Values are in Gwei. The base gas price for the transaction.                                                                                                                  |
...
| max\_wait\_time              | integer | Optional, only used if tx\_type is `Eip1559`. Estimated mxnimum transaction wait time in mempool (in ms) for this priority level.                                            |
