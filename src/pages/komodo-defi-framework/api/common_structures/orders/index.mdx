...
| Structure | Type               | Description                                                                                                             |
| --------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| pair      | array of 2 strings | The trading pair as an array: \[base\_coin, rel\_coin]                                                                  |
| depth     | object             | A [DepthInfo](/komodo-defi-framework/api/common_structures/orders/#depth-info) object containing the ask and bid counts |
