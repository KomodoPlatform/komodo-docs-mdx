...
Used in [orderbook_depth](/komodo-defi-framework/api/legacy/orderbook_depth/) responses to represent the depth information for a trading pair.

| Structure  | Type               | Description                                           |
| ---------- | ------------------ | ----------------------------------------------------- |
| pair       | array of 2 strings | The trading pair as an array: [base_coin, rel_coin]  |
| depth      | object             | A [DepthInfo](#depth-info) object containing the ask and bid counts |

### DepthInfo

Used within [PairDepth](#pair-depth) objects to represent ask and bid counts.
