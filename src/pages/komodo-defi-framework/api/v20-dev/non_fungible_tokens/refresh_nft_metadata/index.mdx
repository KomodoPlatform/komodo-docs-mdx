...
| url\_antispam  | string | If proxy_auth is set to true, will need to provide a new Komodo Proxy URL, otherwise consists of URL link to the [Antispam API proxy base url](https://nft.antispam.dragonhound.info) or equivalent. [docs](https://nft.antispam.dragonhound.info/docs). |
