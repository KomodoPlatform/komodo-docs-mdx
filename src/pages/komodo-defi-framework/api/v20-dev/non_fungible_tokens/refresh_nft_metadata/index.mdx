...
| proxy\_auth  | boolean | Indicates whether authentication is required for accessing the proxy URLs. Set to true if authentication is necessary, otherwise false. |
