...
The [<b>AtomicDEX Tutorials</b>](/komodo-defi-framework/tutorials/) section contains a more thorough conceptual explanation of AtomicDEX.
...
Recently, a `komodefi-cli` binary has been introduced to simplify the process of [interacting with the AtomicDEX daemon from the command line](/komodo-defi-framework/tutorials/using-komodefi-cli-in-console/).
