...
- **Electrum Client**
  ...
  <CollapsibleSection expandedText="Click to hide details" collapsedText="Click to expand details">
...
### ⚡ API Changes
  ...
  - **Cosmos Integration**
    - 'rpc_urls' field (previously a list of plain string values) was replaced by @onur-ozkan with 'nodes' (a list of JSON objects) in Cosmos activation payloads. [#2173](https://github.com/KomodoPlatform/komodo-defi-framework/pull/2173)
  - **Komodo DeFi Proxy**
    - All RPC methods fields controlling komodo-defi-proxy were renamed to 'komodo_proxy' by @onur-ozkan. This affects various activations, including ETH/EVM. [#2173](https://github.com/KomodoPlatform/komodo-defi-framework/pull/2173)
...
**Full Changelog**: https://github.com/KomodoPlatform/komodo-defi-framework/compare/v2.1.0-beta...v2.2.0-beta
...
| [mm2_bb749a993-wasm.zip](https://www.virustotal.com/gui/file/877d42c9051c060609b969aa3dfa550d73ae24f53153dea08143d820e7d317c7) | `877d42c9051c060609b969aa3dfa550d73ae24f53153dea08143d820e7d317c7` |
...
<sub>These scans were produced by the [VirusTotal GitHub Action](https://github.com/crazy-max/ghaction-virustotal)</sub></CollapsibleSection>
