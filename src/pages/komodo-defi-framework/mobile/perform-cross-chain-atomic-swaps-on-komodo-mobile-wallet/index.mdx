export const title = "Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet";
...
<OptimizedImage title="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" src={howToPerform1} classNaming="w-full" alt="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" />
...
<OptimizedImage title="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" src={howToPerform2} classNaming="w-full" alt="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" />
...
<OptimizedImage title="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" src={howToPerform3} classNaming="w-full" alt="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" />
...
<OptimizedImage title="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" src={howToPerform4} classNaming="w-full" alt="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" />

If you are still on the swap monitoring page from before, when your swap completes you will see the following screen.

<OptimizedImage title="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" src={howToPerform5} classNaming="w-full" alt="How to Perform Cross-Chain Atomic Swaps Using Komodo Mobile Wallet" />
