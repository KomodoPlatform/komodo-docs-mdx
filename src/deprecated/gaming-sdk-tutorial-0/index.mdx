export const title = "Gaming Tutorial: Getting Started";
export const description = "This tutorial covers the installation and initiation of the Antara Gaming Software Development Kit (SDK).";
