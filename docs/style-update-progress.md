...
| src/pages/komodo-defi-framework/api/v20/streaming/heartbeat_enable/index.mdx                                 | ✅ Compliant   |
...
| src/pages/komodo-defi-framework/api/v20/utils/task_init_trezor/status/index.mdx                              | ⬜ Pending     |
