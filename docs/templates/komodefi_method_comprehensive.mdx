...
<CollapsibleSection expandedText="Hide Response" collapsedText="Show Response">
  #### Response ([Alternative Scenario] success)
...
| Parameter        | Type   | Description                                    |
| ---------------- | ------ | ---------------------------------------------- |
| [error1]         | string | [Human readable error details]                 |
| [error2]         | string | [Human readable error details]                 |
| [error3]         | string | [Human readable error details]                 |
